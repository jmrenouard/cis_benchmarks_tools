...
|<br>3.1.3 Ensure the logging collector is enabled (Automated) ...................................................... 44|
...
|3.1.6 Ensure the log file permissions are set correctly (Automated) ........................................ 50<br>|
|3.1.7 Ensure 'logtruncateonrotation' is enabled (Automated) ............................................. 52|
|___<br>3.1.8 Ensure the maximum log file lifetime is set correctly (Automated) .................................. 54|
|<br>3.1.9 Ensure the maximum log file size is set correctly (Automated) ....................................... 56|
|3.1.10 Ensure the correct syslog facility is selected (Manual) .................................................. 58|
|3111 Ensure syslog messages are not suppressed (Automated)  60|
|..        ..........................................<br>3.1.12 Ensure syslog messages are not lost due to size (Automated) ..................................... 62|
|<br>3.1.13 Ensure the program name for PostgreSQL syslog messages is correct (Automated) .. 64<br>3.1.14 Ensure the correct messages are written to the server log (Automated)....................... 66|
|3.1.15 Ensure the correct SQL statements generating errors are recorded (Automated) ........ 68<br>3.1.16 Ensure 'debug_print_parse' is disabled (Automated) .................................................... 70<br>|
|3.1.17 Ensure 'debug_print_rewritten' is disabled (Automated)................................................ 72<br>''|
...
|3.1.21 Ensure 'logdisconnections' is enabled (Automated) .................................................... 80|
|_<br>3.1.22 Ensure 'log_error_verbosity' is set correctly (Automated) .............................................. 82|
|<br>3.1.23 Ensure 'log_hostname' is set correctly (Automated) ...................................................... 84|
|3.1.24 Ensure 'log_line_prefix' is set correctly (Automated) ..................................................... 86|
|3.1.25 Ensure 'log_statement' is set correctly (Automated) ...................................................... 88|
|3.1.26 Ensure 'logtimezone' is set correctly (Automated) ....................................................... 90|
|_<br>3.2 Ensure the PostgreSQL Audit Extension (pgAudit) is enabled (Automated) ...................... 92|
...
|4.3 Ensure excessive administrative privileges are revoked (Manual) ................................... 100<br>|
...
|_<br>4.9 Make use of predefined roles (Manual) ............................................................................. 123|
|**5 Connection and Login ........................................................................................................ 126**|
|<br>5.1 Do Not Specify Passwords in the Command Line (Manual) ............................................. 127|
|5.2 Ensure PostgreSQL is Bound to an IP Address (Manual) ................................................ 129<br>|
|5.3 Ensure login via "local" UNIX Domain Socket is configured correctly (Manual) ............... 131|
|<br>5.4 Ensure login via "host" TCP/IP Socket is configured correctly (Manual) .......................... 134|
|<br>5.5 Ensure per-account connection limits are used (Automated) ........................................... 138|
...
|5.6 Ensure Password Complexity is configured (Manual) ...................................................... 139|
|---|
|**6 PostgreSQL Settings .......................................................................................................... 141**|
|6.1 Understanding attack vectors and runtime parameters (Manual) ..................................... 142|
|6.2 Ensure 'backend' runtime parameters are configured correctly (Automated) ................... 144<br>6.3 Ensure 'Postmaster' Runtime Parameters are Configured (Manual) ................................ 146|
|6.4 Ensure 'SIGHUP' Runtime Parameters are Configured (Manual) .................................... 149|
|6.5 Ensure 'Superuser' Runtime Parameters are Configured (Manual) ................................. 153<br>6.6 Ensure 'User' Runtime Parameters are Configured (Manual)........................................... 156|
|6.7 Ensure FIPS 140-2 OpenSSL Cryptography Is Used (Automated) .................................. 160<br>6.8 Ensure TLS is enabled and configured correctly (Automated) ......................................... 163|
|6.9 Ensure the TLSv1.0 and TLSv1.1 Protocols are Disabled (Automated)........................... 167<br>6.10 Ensure Weak SSL/TLS Ciphers Are Disabled (Automated) ........................................... 169|
|6.11 Ensure the pgcrypto extension is installed and configured correctly (Manual) ............... 171|
|**7 Replication ........................................................................................................................... 174**|
|7.1 Ensure a replication-only user is created and used for streaming replication (Manual) ... 175<br>7.2 Ensure logging of replication commands is configured (Manual) ..................................... 177|
|7.3 Ensure base backups are configured and functional (Manual) ......................................... 179<br>7.4 Ensure WAL archiving is configured and functional (Automated) ..................................... 181|
|7.5 Ensure streaming replication parameters are configured correctly (Manual) ................... 183|
|**8 Special Configuration Considerations ............................................................................. 185**|
|8.1 Ensure PostgreSQL subdirectory locations are outside the data cluster (Manual) .......... 186<br>8.2 Ensure the backup and restore tool, 'pgBackRest', is installed and configured (Automated)<br>................................................................................................................................................. 188|
|8.3 Ensure miscellaneous configuration settings are correct (Manual) .................................. 191|
|**_Appendix: Summary Table .......................................................................................... 193_**|
|**_Appendix: Change History .......................................................................................... 198_**|
...
This document, CIS PostgreSQL 16 Benchmark, provides prescriptive guidance for establishing a secure configuration posture for PostgreSQL 16. This guide was tested against PostgreSQL 16 running on RHEL 9, but applies to other Linux distributions as well. To obtain the latest version of this guide, please visit <u>http://benchmarks.cisecurity.org. If you have questions, comments, or have identified</u> ways to improve this guide, please write us at feedback@cisecurity.org. 

### **Intended Audience** 

This document is intended for system and application administrators, security specialists, auditors, help desk, and platform deployment personnel who plan to develop, deploy, assess, or secure solutions that incorporate PostgreSQL 16. 
...
Items in this profile apply to PostgreSQL 16 and intend to: 
...
Items in this profile apply to PostgreSQL 16 running on Linux and intend to: 
...
[snip]
Installed:
  pgdg-redhat-repo-42.0-50.noarch
Complete!
# whoami
root
...
To install the PGDG RPMs for PostgreSQL 16.x, run: 
...
Installed:
<snip>
  postgresql16-16.9-3PGDG.rhel9.x86_64        postgresql16-contrib-16.9-
3PGDG.rhel9.x86_64
  postgresql16-libs-16.9-3PGDG.rhel9.x86_64   postgresql16-server-16.9-
3PGDG.rhel9.x86_64
Complete!
```
...
1. <u>https://www.postgresql.org/docs/current/app-initdb.html</u> 
...
I copied/adjusted this rule from CIS MySQL, rule 1.4 
...
```
sudo /usr/pgsql-16/bin/pg_config --sharedir
/usr/pgsql-16/share
```
...
```
sudo export ext_dir=/usr/pgsql-16/share/extension
sudo ls -ld $ext_dir
```
...
```
drwxr-xr-x 1 root root 7826 Feb  9 14:27 /usr/pgsql-16/share/extension
```
...
|v8|Configure data access control lists based on a user’s need to know. Apply<br>data access control lists, also known as access permissions, to local and remote<br>file systems, databases, and applications.|●|●|●|
...
2. Create `~` _`<user>`_ `/.psql_history` as a symbolic to `/dev/null` . 
...
|v8|Securely dispose of data as outlined in the enterprise’s data management<br>process. Ensure the disposal process and method are commensurate with the<br>data sensitivity.|●|●|●|
...
|v8|Configure detailed audit logging for enterprise assets containing sensitive data.<br>Include event source, date, username, timestamp, source addresses, destination<br>addresses, and other useful elements that could assist in a forensic investigation.|●|●|
...
|---|---|---|---|---|
|v8|8.5Collect Detailed Audit Logs<br>Configure detailed audit logging for enterprise assets containing sensitive data.<br>Include event source, date, username, timestamp, source addresses, destination<br>addresses, and other useful elements that could assist in a forensic investigation.||●|●|
||6.3Enable Detailed Logging||||
|v7|Enable system logging to include detailed information such as an event source,<br>date, user, timestamp, source addresses, destination addresses, and other useful<br>elements.||●|●|
...
pricelExecute the following SQL statement(s) as superuser to remediate this setting (in this example, to `verbose` ): 
...
##### <u>and, finally, restart the PostgreSQL service:</u> 
...
1. <u>https://www.postgresql.org/docs/current/static/ddl-rowsecurity.html</u> 2. <u>https://www.postgresql.org/docs/current/static/sql-alterrole.html</u> 
...
The following predefined roles exist in PostgreSQL 1*.x: 
...
###### <u><mark>`psql -u <user> --password`</mark></u> 
...
This example permits encrypted sessions for the `postgres` role and denies all unencrypted sessions for the <u>`postgres`</u> role: 
...
|`postgres=# SELECT name, setting FROM`<br>`ORDER BY 1;`|`pg_settings WHERE context = 'postmaster'`|
|---|---|
|`name`<br>|`|                setting`<br>|
|`-------------------------------------`<br>`-`<br>`archive_mode`|`+---------------------------------------`<br>`| off`|
|`autovacuum_freeze_max_age`|`| 200000000`|
|`autovacuum_max_workers`|`| 3`|
|`autovacuum_multixact_freeze_max_age`|`| 400000000`|
|`bonjour`|`| off`|
|`bonjour_name`|`|`|
|`cluster_name`<br>`config_file`|`|`<br>`| /var/lib/pgsql/16/data/postgresql.conf`|
...
|`data_sync_retry`<br>`debug_io_direct`|`| off`<br>`|`|
|---|---|
...
|`hot_standby`|`| on`|
|`huge_pages`|`| try`|
|`huge_page_size`<br>`ident_file`|`| 0`<br>`| /var/lib/pgsql/16/data/pg_ident.conf`|
|`ignore_invalid_pages`|`| off`|
|`jit_provider`|`| llvmjit`|
|`listen_addresses`|`| localhost`|
|`logging_collector`|`| on`|
|`max_connections`|`| 100`|
|<br>`max_files_per_process`|<br>`| 1000`|
|`max_locks_per_transaction`|`| 64`|
|`max_logical_replication_workers`|`| 4`|
|<br>`max_pred_locks_per_transaction`|<br>`| 64`|
|`maxpreparedtransactions`|`| 0`|
|`__`<br>`maxreplicationslots`|<br>`| 10`|
|`__`<br>`max_wal_senders`|<br>`| 10`|
|`maxworkerprocesses`|`| 8`|
|`__`<br>`min_dynamic_shared_memory`<br>`old_snapshot_threshold`<br>|<br>`| 0`<br>`| -1`<br>|
|`port`|`| 5432`|
|`recovery_target`<br>`recovery_target_action`|`|`<br>`| pause`|
|`recovery_target_inclusive`|`| on`|
|`recovery_target_lsn`<br>`recovery_target_name`|`|`<br>`|`|
...
|<br>`track_commit_timestamp`|<br>`| off`|
|`unix_socket_directories`|`| /var/run/postgresql, /tmp`|
|<br>`unix_socket_group`|<br>`|`|
|<br>`unixsocketpermissions`|<br>`| 0777`|
|`__`<br>`walbuffers`|<br>`| 512`|
|`_`<br>`wal_decode_buffer_size`|<br>`| 524288`|
|`wal_level`|`| replica`|
|`wal_log_hints`<br>`(57 rows)`|`| off`|
...
|`autovacuum_analyze_threshold                | 50`<br>`autovacuumnaptime                          | 60`|
|---|
|`_`<br>`autovacuumvacuumcostdelay                | 2`|
|`___`<br>`autovacuum_vacuum_cost_limit                | -1`|
|`autovacuum_vacuum_insert_scale_factor       | 0.2`|
|`autovacuumvacuuminsertthreshold          | 1000`|
|`___`<br>`autovacuum_vacuum_scale_factor              | 0.2`<br>|
...
|`__`<br>`checkpoint_completion_target                | 0.9`|
|<br>`checkpoint_flush_after                      | 32`|
|`checkpoint_timeout                          | 300`|
|`checkpointwarning                          | 30`|
|`_`<br>`db_user_namespace                           | off`|
|`fsync                                       | on`|
|`full_page_writes                            | on`|
...
|<br>`log_rotation_size                           | 0`|
|`log_startup_progress_interval               | 10000`|
|`log_timezone                                | UTC`|
|`log_truncate_on_rotation                    | on`|
|`max_parallel_apply_workers_per_subscription | 2`<br>|
|`maxpredlocksperpage                     | 2`|
|`____`<br>`max_pred_locks_per_relation                 | -2`|
|`maxslotwalkeesize                      | -1`|
|`___p_`<br>`maxstandbyarchivedelay                   | 30000`|
|`___`<br>`max_standby_streaming_delay                 | 30000`|
|<br>`maxsyncworkerspersubscription           | 2`|
|`____`<br>`max_wal_size                                | 1024`|
|`minwalsize                                | 80`|
|`__`<br>`preauthdelay                              | 0`|
|`__`<br>`primary_conninfo                            |`|
|`primary_slot_name                           |`|
|`recoveryendcommand                        |`|
|`__`<br>`recoveryinitsyncmethod                   | fsync`|
|`___`<br>`recovery_min_apply_delay                    | 0`|
|<br>`recovery_prefetch                           | try`|
|`removetempfilesaftercrash               | on`|
|`____`<br>`restart_after_crash                         | on`|
...
|`set_user.block_alter_system                 | on`<br>|
...
|`loglockwaits                 | off`|
|`__`<br>`log_min_duration_sample        | -1`|
|`log_min_duration_statement     | -1`|
|`log_min_error_statement        | error`|
|`log_min_messages               | warning`|
|`logparametermaxlength       | -1`|
|`___`<br>`logparserstats               | off`|
|`__`<br>`log_planner_stats              | off`|
|`log_replication_commands       | off`|
|`log_statement                  | none`|
|`log_statement_sample_rate      | 1`|
|`logstatementstats            | off`|
|`__`<br>`logtempfiles                 | -1`|
|`__`<br>`log_transaction_sample_rate    | 0`|
|`max_stack_depth                | 2048`|
|`pgaudit.log                    | ddl,write`|
|`pgaudit.log_catalog            | on`|
|`pgaudit.log_client             | off`|
|`pgaudit.loglevel              | log`|
|`_`<br>`pgaudit.log_parameter          | off`|
...
|`enable_hashagg                      | on`|
|`enable_hashjoin                     | on`|
|`enable_incremental_sort             | on`<br>|
|`enable_indexonlyscan                | on`|
|`enable_indexscan                    | on`|
|`enable_material                     | on`|
|`enable_memoize                      | on`<br>|
|`enable_mergejoin                    | on`|
|`enable_nestloop                     | on`|
...
|`enable_presorted_aggregate          | on`<br>|
...
|`geqo_threshold                      | 12`|
|<br>`gin_fuzzy_search_limit              | 0`|
|`gin_pending_list_limit              | 4096`|
|<br>`hash_mem_multiplier                 | 2`|
|`icu_validation_level                | warning`|
|`idle_in_transaction_session_timeout | 0`<br>|
|`idlesessiontimeout                | 0`|
|`__`<br>`IntervalStyle                       | postgres`|
|`jit                                 | on`|
|`jit_above_cost                      | 100000`|
|`jitexpressions                     | on`|
|`_`<br>`jit_inline_above_cost               | 500000`|
...
|`jit_optimize_above_cost             | 500000`<br>`jittupledeforming                 | on`|
|---|
|`__`<br>`join_collapse_limit                 | 8`|
|`lc_monetary                         | en_US.UTF-8`|
|`lc_numeric                          | en_US.UTF-8`<br>|
|`lctime                             | enUS.UTF-8`|
|`_                              _`<br>`local_preload_libraries             |`|
|`lock_timeout                        | 0`|
|`logical_decoding_work_mem           | 65536`|
|`log_parameter_max_length_on_error   | 0`<br>|
|`maintenance_io_concurrency          | 10`<br>|
...
|`recursive_worktable_factor          | 10`<br>|
|`row_security                        | on`|
|`scram_iterations                    | 4096`|
|`search_path                         | "$user", public`<br>|
|`seqpagecost                       | 1`|
|`__`<br>`standard_conforming_strings         | on`|
|`statement_timeout                   | 0`|
...
|<br>`transaction_read_only               | off`|
|`transformnullequals               | off`|
|`__`<br>`vacuum_buffer_usage_limit           | 256`|
|`vacuum_cost_delay                   | 0`|
|`vacuumcostlimit                   | 200`|
|`__`<br>`vacuumcostpagedirty              | 20`|
|`___`<br>`vacuum_cost_page_hit                | 1`|
|`vacuum_cost_page_miss               | 2`|
|`vacuum_failsafe_age                 | 1600000000`|
|`vacuumfreezeminage               | 50000000`|
|`___`<br>`vacuum_freeze_table_age             | 150000000`|
...
```
grep --extended-regexp "^[^#]*ssl_ciphers" $PGDATA/postgresql.conf |
cut -d ' ' -f 3 |sed "s/'//g" | tr ":" "\n"
```
...
|---|---|---|---|---|
|v8|5.4Restrict Administrator Privileges to Dedicated<br>Administrator Accounts<br>Restrict administrator privileges to dedicated administrator accounts on<br>enterprise assets. Conduct general computing activities, such as internet<br>browsing, email, and productivity suite use, from the user’s primary, non-privileged<br>account.|●|●|●|
||4.3Ensure the Use of Dedicated Administrative Accounts||||
|v7|Ensure that all users with administrative account access use a dedicated or<br>secondary account for elevated activities. This account should only be used for<br>administrative activities and not internet browsing, email, or similar activities.|●|●|●|
...
To relocate `temp_tablespaces` to an existing mount point outside the data cluster is <u>accomplished by:</u> 
...
status: ok
db (current)
  wal archive min/max (1*.0-1): 000000010000000000000012 /
...
<snip>
Installed:
  libssh2-1.10.0-1.el9.x86_64                          pgbackrest-2.55.1-
1PGDG.rhel9.x86_64
Complete!
```
...
|Feb 16, 2023|1.0.0|Removed recommendation 8.1<br>and renumberd following<br>recommendations accordingly.|
...
|Jun 2, 2025|1.1.0|Wrong profile (Ticket 24786)|
|Jun 2, 2025|1.1.0|Alternative Audit Procedure<br>(Ticket 24499)|
|Jun 2, 2025|1.1.0|control 6.10 requires re-writing<br>(Ticket 21424)|
|Jun 2, 2025|1.1.0|Audit Procedure (validation) for<br>6.8 control (Ticket 21423)|
|Jun 2, 2025|1.1.0|Wrong reference in the<br>Description (Ticket 19230)|
