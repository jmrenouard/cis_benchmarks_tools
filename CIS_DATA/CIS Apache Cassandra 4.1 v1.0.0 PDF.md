...
For information on referencing and/or citing CIS Benchmarks in 3<sup>rd</sup> party documentation (including using portions of Benchmark Recommendations) please contact CIS Legal (CISLegal@cisecurity.org) and request guidance on copyright usage. 
...
|**Title ............................................................................................................................................... 8**|
|**Assessment Status .................................................................................................................... 8**<br>|
|**Automated ............................................................................................................................................... 8**<br>**Manual...................................................................................................................................................... 8**|
|**Profile ........................................................................................................................................... 8**|
|**Description .................................................................................................................................. 8**|
...
|**1 Installation and Updates ....................................................................................................... 13**|
|1.1 Ensure a separate user and group exist for Cassandra (Manual) ...................................... 14|
|<br>1.2 Ensure the latest version of Java is installed (Automated) ................................................. 16<br>1.3 Ensure the latest version of Python is installed (Automated).............................................. 18|
|<br>1.4 Ensure latest version of Cassandra is installed (Automated) ............................................. 20|
|<br>1.5 Ensure the Cassandra service is run as a non-root user (Automated) ............................... 22<br>1.6 Ensure clocks are synchronized on all nodes (Manual) ...................................................... 24|
|**2 Authentication and Authorization ....................................................................................... 26**|
|2.1 Ensure that authentication is enabled for Cassandra databases (Automated) .................. 27<br>2.2 Ensure that authorization is enabled for Cassandra databases (Automated) .................... 29|
...
|**3 Access Control / Password Policies ................................................................................... 31**|
|---|
|3.1 Ensure the cassandra and superuser roles are separate (Automated) .............................. 32|
|3.2 Ensure that the default password is changed for the cassandra role (Automated) ............ 34<br>|
|3.3 Ensure there are no unnecessary roles or excessive privileges (Manual) ......................... 36<br>|
|3.4 Ensure that Cassandra is run using a non-privileged, dedicated service account<br>(Automated) ............................................................................................................................... 38<br>|
|3.5 Ensure that Cassandra only listens for network connections on authorized interfaces<br>(Manual) ..................................................................................................................................... 40|
|3.6 Ensure that Data Center Authorizations is activated (Manual) ........................................... 42|
|3.7 Review User-Defined Roles (Manual) ................................................................................. 44|
|3.8 Review Superuser/Admin Roles (Manual) .......................................................................... 46|
|**4 Auditing and Logging ........................................................................................................... 48**<br>|
|4.1 Ensure that logging is enabled. (Automated) ...................................................................... 49|
|4.2 Ensure that auditing is enabled (Manual) ............................................................................ 51|
|**5 Encryption .............................................................................................................................. 53**<br>|
|5.1 Inter-node Encryption (Automated) ..................................................................................... 54|
|5.2 Client Encryption (Automated) ............................................................................................ 56|
|**_Appendix: Summary Table ............................................................................................ 58_**|
|**_Appendix: CIS Controls v7 IG 1 Mapped Recommendations ................................... 60_**|
|**_Appendix: CIS Controls v7 IG 2 Mapped Recommendations ................................... 61_**|
|**_Appendix: CIS Controls v7 IG 3 Mapped Recommendations ................................... 62_**|
|**_Appendix: CIS Controls v7 Unmapped Recommendations ...................................... 63_**|
|**_Appendix: CIS Controls v8 IG 1 Mapped Recommendations ................................... 64_**|
|**_Appendix: CIS Controls v8 IG 2 Mapped Recommendations ................................... 65_**|
|**_Appendix: CIS Controls v8 IG 3 Mapped Recommendations ................................... 66_**|
|**_Appendix: CIS Controls v8 Unmapped Recommendations ...................................... 67_**|
|**_Appendix: Change History ............................................................................................ 68_**|
...
All CIS Benchmarks™ are available free for non-commercial use from the CIS Website. They can be used to **_manually_** assess and remediate systems and applications. In lieu of manual assessment and remediation, there are several tools available to assist with assessment: 
...
**NOTE** :  Some tooling focuses only on the CIS Benchmarks™ Recommendations that can be fully automated (skipping ones marked **Manual** ). It is important that **_ALL_** Recommendations ( **Automated** and **Manual** ) be addressed, since all are important for properly securing systems and are typically in scope for audits. 
...
This document, CIS Apache Cassandra Benchmark, provides prescriptive guidance for establishing a secure configuration posture for Apache Cassandra version 4.1. This guide was tested against Apache Cassandra running on CentOS Linux 7, but applies to other Linux distributions as well. To obtain the latest version of this guide, please visit <u>http://benchmarks.cisecurity.org. If you have questions, comments, or have identified</u> ways to improve this guide, please write us at feedback@cisecurity.org. 
...
**Editor** Randall Mowen 

**Contributor** Tony Wilwerding Chirag Shah Apache Cassandra Community 
...
If an old/unsupported version of Java is installed this is a finding. Apache Cassandra expects a version of 1.8. 
...
Open the `cassandra.yaml` file in a text editor In the `audit_logging_options` section, set `enabled` to `true` . 
...
Open up the `cassandra.yaml` file, look for client_encryption_options section. Look for `enabled:` and `optional:` 
...
|3.2|Ensure that the default password is changed for the<br>cassandra role (Automated)|||
...
|3.6|Ensure that Data Center Authorizations is activated<br>(Manual)|||
...
|3.7|ReviewUser-DefinedRoles|||
|3.8|ReviewSuperuser/Admin Roles|||
...
|1.3|Ensure thelatestversionof Python isinstalled|||
|1.4|EnsurelatestversionofCassandraisinstalled|||
|1.5|Ensure the Cassandra serviceisrunas anon-root user|||
|1.6|Ensure clocks are synchronized onall nodes|||
|3.1|Ensure the cassandra and superuser roles are separate|||
|3.2|Ensure that the default password is changed for the<br>cassandrarole|||
|3.3|Ensure there are no unnecessary roles or excessive<br>privileges|||
|3.4|Ensure that Cassandra is run using a non-privileged,<br>dedicated service account|||
...
|3.1|Ensure the cassandra and superuser roles are separate|||
|3.2|Ensure that the default password is changed for the<br>cassandra role|||
|3.3|Ensure there are no unnecessary roles or excessive<br>privileges|||
|3.4|Ensure that Cassandra is run using a non-privileged,<br>dedicated service account|||
|3.5|Ensure that Cassandra only listens for network<br>connections onauthorizedinterfaces|||
|3.6|Ensure thatData Center Authorizationsis activated|||
|3.7|ReviewUser-DefinedRoles|||
|3.8|ReviewSuperuser/Admin Roles|||
|4.1|Ensure thatloggingis enabled.|||
|4.2|Ensure that auditingis enabled|||
