...
|---|
|1.6 Verify That MYSQL_PWD is Not Set in Users Profiles (Automated) ................................ 29<br>1.7 Ensure MySQL is Run Under a Sandbox Environment (Manual) ....................................... 31|
|**2 Installation and Planning ...................................................................................................... 35**|
|**2.1 Backup and Disaster Recovery ..................................................................................................... 36**<br>|
|2.1.1 Backup Policy in Place (Manual) ...................................................................................... 37<br>|
|2.1.2 Verify Backups are Good (Manual) .................................................................................. 38|
|<br>2.1.3 Secure Backup Credentials (Manual) .............................................................................. 39|
|<br>2.1.4 The Backups Should be Properly Secured (Manual) ....................................................... 40|
|2.1.5 Point-in-Time Recovery (Automated) ............................................................................... 42<br>|
|2.1.6 Disaster Recovery (DR) Plan (Manual) ............................................................................ 44|
|<br>2.1.7 Backup of Configuration and Related Files (Manual) ...................................................... 46|
|<br>**2.2 Data Encryption .............................................................................................................................. 48**|
|2.2.1 Ensure Binary and Relay Logs are Encrypted (Automated) ............................................ 49|
|2.3 Dedicate the Machine Running MySQL (Manual) ............................................................... 51<br>|
|2.4 Do Not Specify Passwords in the Command Line (Manual) ............................................... 53|
|<br>2.5 Do Not Reuse Usernames (Manual) ................................................................................... 55|
|<br>2.6 Ensure Non-Default, Unique Cryptographic Material is in Use (Manual) ............................ 57|
|2.7 Ensure 'password_lifetime' is Less Than or Equal to '365' (Automated) ............................ 58|
|2.8 Ensure Password Resets Require Strong Passwords (Automated) ................................... 60|
|<br>2.9 Require Current Password for Password Reset (Automated) ............................................ 62|
|<br>2.10 Use Dual Passwords to Enable Higher Frequency Password Rotation (Manual) ............ 63|
|2.11 Lock Out Accounts if Not Currently in Use (Manual) ........................................................ 65<br>2.12 Ensure AES Encryption Mode for AES_ENCRYPT/AES_DECRYPT is Configured<br>Correctly (Automated) ............................................................................................................... 67<br>|
|2.13 Ensure Socket Peer-Credential Authentication is Used Appropriately (Manual) .............. 69|
|2.14 Ensure MySQL is Bound to an IP Address (Automated) .................................................. 71|
|2.15 Limit Accepted Transport Layer Security (TLS) Versions (Automated) ............................ 73<br>|
|2.16 Require Client-Side Certificates (X.509) (Automated) ...................................................... 75<br>|
|2.17 Ensure Only Approved Ciphers are Used (Automated) .................................................... 77|
|<br>2.18 Implement Connection Delays to Limit Failed Login Attempts (Automated) .................... 79|
|2.19 Ensure FIPS 140-2 OpenSSL Cryptography Is Used (Manual) ........................................ 81|
|**3 File Permissions .................................................................................................................... 86**<br>|
|3.1 Ensure 'datadir' Has Appropriate Permissions (Automated) ............................................... 87|
|<br>3.2 Ensure 'logbinbasename' Files Have Appropriate Permissions (Automated) ................ 89|
|__<br>3.3 Ensure 'log_error' Has Appropriate Permissions (Automated) ........................................... 91|
|3.4 Ensure 'slow_query_log' Has Appropriate Permissions (Automated) ................................. 93|
|3.5 Ensure 'relay_log_basename' Files Have Appropriate Permissions (Automated) ............. 96<br>|
|3.6 Ensure 'generallogfile' Has Appropriate Permissions (Automated) ................................ 98|
|__<br>3.7 Ensure SSL Key Files Have Appropriate Permissions (Automated) ................................ 101|
|<br>3.8 Ensure Plugin Directory Has Appropriate Permissions (Automated) ................................ 103|
|39 Ensure 'auditlofile' Has Aroriate Permissions (Automated)  105|
|.  _g_  ppp   ..................................<br>3.10 Secure MySQL Keyring (Automated) .............................................................................. 107|
|**4 General ................................................................................................................................. 110**|
|4.1 Ensure the Latest Security Patches are Applied (Manual) ............................................... 111|
|<br>4.2 Ensure Example or Test Databases are Not Installed on Production Servers (Automated)|
|................................................................................................................................................. 113|
|4.3 Ensure 'allow-suspicious-udfs' is Set to 'OFF' (Automated) .............................................. 115|
|<br>4.4 Harden Usage for 'localinfile' on MySQL Clients (Automated) ....................................... 117|
|_<br>4.5 Ensure 'mysqld' is Not Started With '--skip-grant-tables' (Automated) ............................. 119|
|4.6 Ensure Symbolic Links are Disabled (Automated) ............................................................ 121|
|4.7 Ensure the 'daemon_memcached' Plugin is Disabled (Automated) ................................. 123<br>|
|4.8 Ensure the 'securefilepriv' is Configured Correctly (Automated) .................................. 125|
|__<br>4.9 Ensure 'sql_mode' Contains 'STRICT_ALL_TABLES' (Automated) ................................. 127|
...
|4.10 Use MySQL TDE for At-Rest Data Encryption (Automated) ........................................... 129|
|---|
|**5 MySQL Permissions ............................................................................................................ 132**|
|5.1 Ensure Only Administrative Users Have Full Database Access (Manual)........................ 133<br>|
|5.2 Ensure 'FILE' is Not Granted to Non-Administrative Users (Manual) ............................... 135|
|5.3 Ensure 'PROCESS' is Not Granted to Non-Administrative Users (Manual) ..................... 137|
|5.4 Ensure 'SUPER' is Not Granted to Non-Administrative Users (Manual) .......................... 139|
|5.5 Ensure 'SHUTDOWN' is Not Granted to Non-Administrative Users (Manual).................. 142|
|5.6 Ensure 'CREATE USER' is Not Granted to Non-Administrative Users (Manual) ............. 144|
|5.7 Ensure 'GRANT OPTION' is Not Granted to Non-Administrative Users (Manual) ........... 146<br>|
|5.8 Ensure 'REPLICATION SLAVE' is Not Granted to Non-Administrative Users (Manual) .. 148|
|5.9 Ensure DML/DDL Grants are Limited to Specific Databases and Users (Manual) .......... 150|
|5.10 Securely Define Stored Procedures and Functions DEFINER and INVOKER (Manual)152<br>5.11 Ensure Proper Use Of 'SET_ANY_DEFINER' (Manual) ................................................. 154|
|<br>5.12 Ensure Proper Use Of ALLOW_NONEXISTENT_DEFINER (Manual) .......................... 156|
|**6 Auditing and Logging ......................................................................................................... 158**|
|6.1 Ensure 'log_error' is configured correctly (Automated) ..................................................... 159|
|6.2 Ensure Log Files are Stored on a Non-System Partition (Automated) ............................. 161|
|6.3 Ensure 'log_error_verbosity' is Set to '2' (Automated) ...................................................... 163|
|6.4 Ensure 'log-raw' is Set to 'OFF' (Automated) .................................................................... 165|
|6.5 Ensure Audit Filters Capture Connection Attempts (Manual) ........................................... 167|
|6.6 Ensure ALL Events are Audited (Automated) ................................................................... 170|
|6.7 Set audit_log_strategy to SYNCHRONOUS or SEMISYNCRONOUS (Automated) ........ 172|
|6.8 Ensure the Audit Plugin Can't be Unloaded (Automated) ................................................. 174|
|**7 Authentication ..................................................................................................................... 176**|
|7.1 Ensure default_authentication_plugin is Set to a Secure Option (Automated) ................. 177|
|7.2 Ensure Passwords are Not Stored in the Global Configuration (Automated) ................... 179|
|7.3 Ensure Passwords are Set for All MySQL Accounts (Automated) ................................... 181|
|7.4 Set 'default_password_lifetime' to Require a Yearly Password Change (Automated) ..... 183|
|7.5 Ensure Password Complexity Policies are in Place (Automated) ..................................... 185|
|7.6 Ensure No Users Have Wildcard Hostnames (Automated) .............................................. 188|
|7.7 Ensure No Anonymous Accounts Exist (Automated) ........................................................ 189|
|**8 Network ................................................................................................................................. 191**|
|8.1 Ensure 'require_secure_transport' is Set to 'ON' (Automated) ......................................... 192|
|8.2 Ensure 'ssl_type' is Set to 'ANY', 'X509', or 'SPECIFIED' for All Remote Users (Automated)<br>|
|................................................................................................................................................. 194|
|8.3 Set Maximum Connection Limits for Server and per User (Manual) ................................ 196|
|**9 Replication ........................................................................................................................... 198**<br>|
|91 Ensure Replication Traffic is Secured (Manual)  199|
|.       ................................................................<br>9.2 Ensure 'SOURCESSLVERIFYSERVERCERT' is Set to 'YES' or '1' (Automated) ... 201|
|____<br>9.3 Ensure 'masterinforepository' is Set to 'TABLE' (Automated) ....................................... 203|
|__<br>9.4 Ensure 'super_priv' is Not Set to 'Y' for Replication Users (Automated) ........................... 204|
|**10 MySQL InnoDB Cluster / Group Replication .................................................................. 207**|
|<br>10.1 Ensure All Group Replication Traffic is Secured (Manual).............................................. 208|
|<br>10.2 Allowlist Approved Servers Belonging to a MySQL InnoDB Cluster (Manual) ............... 210|
|**_Appendix: Summary Table .......................................................................................... 212_**|
|**_Appendix: Change History .......................................................................................... 219_**|
...
_This is the final release of the CIS Benchmark for Oracle MySQL Enterprise Edition 8.0. CIS encourages you to migrate to a more recent, supported version of this technology._ 
...
**Contributor** Sara Archacki Harin Vadodaria Krishna Rayavaram MDominick Walter York 



**Editor** Tim Harrison, Center for Internet Security, New York Robin Drake 
...
Alter those two paths to be the new location you chose above. For example, if that new location were `/media/mysql` , then the 
...
1. <u>https://dev.mysql.com/doc/mysql-secure-deployment-guide/8.0/en/securedeployment-permissions.html</u> 
...
|**Controls**<br>**Version**|**Control**<br>**IG 1**|<br>**IG 2**|**IG 3**|
|---|---|---|---|
...
1. <u>https://dev.mysql.com/doc/refman/8.0/en/changing-mysql-user.html</u> 

2. <u>https://dev.mysql.com/doc/refman/8.0/en/serveroptions.html#option_mysqld_user</u> 
...
Controls Version  Control  IG 1 IG 2 IG 3<br>14 Controlled Access Based on the Need to Know<br>v7<br>Controlled Access Based on the Need to Know<br><!-- End of picture text -->
...
2. Use either of the techniques below to prevent it from being created again: `o` Set the `MYSQL_HISTFILE` environment variable to `/dev/null.` This will need to be placed in the shell's startup script. 
...
1. <u>https://dev.mysql.com/doc/refman/8.0/en/mysql-logging.html</u> 

2. <u>https://bugs.mysql.com/bug.php?id=72158</u> 

3. <u>https://dev.mysql.com/doc/mysql-shell/8.0/en/mysql-shell-working-withhistory.html</u> 



<!-- Start of picture text -->
CIS Controls:<br>Controls<br>Control  IG 1  IG 2  IG 3<br>Version<br>3.5 Securely Dispose of Data<br>v8  Securely dispose of data as outlined in the enterprise’s data management  ● ● ●<br>process. Ensure the disposal process and method are commensurate with the data<br>sensitivity.<br>13.2 Remove Sensitive Data or Systems Not Regularly<br>Accessed by Organization<br>v7  Remove sensitive data or systems not regularly accessed by the organization  ● ● ●<br>from the network. These systems shall only be used as stand alone systems<br>(disconnected from the network) by the business unit needing to occasionally use<br>the system or completely virtualized and powered off until needed.<br><!-- End of picture text -->
...
1. <u>https://dev.mysql.com/doc/refman/8.0/en/environment-variables.html</u> 2. <u>https://dev.mysql.com/doc/refman/8.0/en/mysql-config-editor.html</u> 

3. <u>https://dev.mysql.com/doc/refman/8.0/en/pluggable-authentication.html</u> 
...
<!-- Start of picture text -->
Encrypt or hash with a salt all authentication credentials when stored.<br><!-- End of picture text -->
...
1. <u>https://dev.mysql.com/doc/refman/8.0/en/environment-variables.html</u> 
...
1. <u>https://dev.mysql.com/doc/refman/8.0/en/serveroptions.html#option_mysqld_chroot</u> 

2. <u>https://dev.mysql.com/doc/refman/8.0/en/docker-mysql-getting-started.html</u> 
...
1. <u>https://dev.mysql.com/doc/mysql-enterprise-backup/8.0/en/meb-encryptedinnodb.html</u> 
...
<!-- Start of picture text -->
Controls<br>Control  IG 1  IG 2  IG 3<br>Version<br>11.3 Protect Recovery Data<br>v8  ● ● ●<br>Protect recovery data with equivalent controls to the original data. Reference<br>encryption or data separation, based on requirements.<br>10.4 Ensure Protection of Backups<br>v7  Ensure that backups are properly protected via physical security or encryption  ● ● ●<br>when they are stored, as well as when they are moved across the network. This<br>includes remote backups and cloud services.<br><!-- End of picture text -->
...
1. <u>https://dev.mysql.com/doc/refman/8.0/en/replication-options-binarylog.html#sysvar_binlog_expire_logs_seconds</u> 

2. <u>https://dev.mysql.com/doc/refman/8.0/en/point-in-time-recovery-binlog.html</u> 
...
<!-- Start of picture text -->
Controls<br>Control  IG 1  IG 2  IG 3<br>Version<br>11.2 Perform Automated Backups<br>v8  ● ● ●<br>Perform automated backups of in-scope enterprise assets. Run backups<br>weekly, or more frequently, based on the sensitivity of the data.<br>10.2 Perform Complete System Backups<br>v7  Ensure that each of the organization's key systems are backed up as a  ● ● ●<br>complete system, through processes such as imaging, to enable the quick<br>recovery of an entire system.<br><!-- End of picture text -->
...
1. <u>https://dev.mysql.com/doc/refman/8.0/en/group-replication-security.html</u> 2. <u>https://dev.mysql.com/doc/refman/8.0/en/replication-security.html</u> 
...
1. <u>https://dev.mysql.com/doc/refman/8.0/en/replication-binlog-encryption.html</u> 

2. <u>https://dev.mysql.com/doc/mysql-enterprise-backup/8.0/en/advanced.encryptedbinlog-relaylog.html</u> 

3. <u>https://dev.mysql.com/doc/refman/8.0/en/replication-options-binarylog.html#sysvar_binlog_encryption</u> 
...
1. <u>https://dev.mysql.com/doc/refman/8.0/en/mysql-config-editor.html</u> 

2. <u>https://dev.mysql.com/doc/refman/8.0/en/password-security-user.html</u> 3. <u>https://dev.mysql.com/doc/mysql-shell/8.0/en/mysql-shell-pluggable-passwordstore.html</u> 



<!-- Start of picture text -->
CIS Controls:<br>Controls<br>Control  IG 1  IG 2  IG 3<br>Version<br>3.10 Encrypt Sensitive Data in Transit<br>v8  ● ●<br>Encrypt sensitive data in transit. Example implementations can include:<br>Transport Layer Security (TLS) and Open Secure Shell (OpenSSH).<br>16.4 Encrypt or Hash all Authentication Credentials<br>v7  ● ●<br>Encrypt or hash with a salt all authentication credentials when stored.<br><!-- End of picture text -->
...
1. <u>https://dev.mysql.com/doc/refman/8.0/en/using-encrypted-connections.html</u> 
...
2. <u>https://dev.mysql.com/doc/refman/8.0/en/validate-password.html</u> 
...
<!-- Start of picture text -->
References:<br>1.  https://dev.mysql.com/doc/refman/8.0/en/password-<br>management.html#password-reuse-policy<br>CIS Controls:<br>Controls<br>Control  IG 1  IG 2  IG 3<br>Version<br>5.2 Use Unique Passwords<br>v8  Use unique passwords for all enterprise assets. Best practice implementation  ● ● ●<br>includes, at a minimum, an 8-character password for accounts using MFA and a<br>14-character password for accounts not using MFA.<br><!-- End of picture text -->
...
1. <u>https://dev.mysql.com/doc/refman/8.0/en/server-systemvariables.html#sysvar_password_require_current</u> 
...
1. <u>https://dev.mysql.com/doc/refman/8.0/en/password-management.html#dualpasswords</u> 
...
1. <u>https://dev.mysql.com/doc/refman/8.0/en/account-locking.html</u> 
...
<!-- Start of picture text -->
Controls<br>Control  IG 1  IG 2  IG 3<br>Version<br>5.3 Disable Dormant Accounts<br>v8  ● ● ●<br>Delete or disable any dormant accounts after a period of 45 days of<br>inactivity, where supported.<br>16.9 Disable Dormant Accounts<br>v7  ● ● ●<br>Automatically disable dormant accounts after a set period of inactivity.<br><!-- End of picture text -->
...
1. <u>https://dev.mysql.com/doc/mysql-secure-deployment-guide/8.0/en/securedeployment-block-encryption-mode.html</u> 



<!-- Start of picture text -->
CIS Controls:<br>Controls<br>Control  IG 1  IG 2  IG 3<br>Version<br>16.11 Leverage Vetted Modules or Services for Application<br>Security Components<br>Leverage vetted modules or services for application security components, such<br>as identity management, encryption, and auditing and logging. Using platform<br>v8  ● ●<br>features in critical security functions will reduce developers’ workload and minimize<br>the likelihood of design or implementation errors. Modern operating systems provide<br>effective mechanisms for identification, authentication, and authorization and make<br>those mechanisms available to applications. Use only standardized, currently<br>accepted, and extensively reviewed encryption algorithms. Operating systems also<br>provide mechanisms to create and maintain secure audit logs.<br>18.5 Use Only Standardized and Extensively Reviewed<br>v7  Encryption Algorithms  ● ●<br>Use only standardized and extensively reviewed encryption algorithms.<br><!-- End of picture text -->
...
1. <u>https://dev.mysql.com/doc/mysql-secure-deployment-guide/8.0/en/securedeployment-configure-authentication.html#secure-deployment-auth-socket</u> 



<!-- Start of picture text -->
CIS Controls:<br><!-- End of picture text -->



<!-- Start of picture text -->
Controls<br>Control  IG 1  IG 2  IG 3<br>Version<br>6.6 Establish and Maintain an Inventory of Authentication<br>and Authorization Systems<br>v8  ● ●<br>Establish and maintain an inventory of the enterprise’s authentication and<br>authorization systems, including those hosted on-site or at a remote service<br>provider. Review and update the inventory, at a minimum, annually, or more<br>frequently.<br><!-- End of picture text -->
...
1. <u>https://dev.mysql.com/doc/mysql-secure-deployment-guide/8.0/en/securedeployment-secure-connections.html</u> 
...
Set the version(s) of TLS you wish to accept in `mysql.conf` specify TLS and Ciphers. For example to only accept TLS 1.3 set `tls_version` in `my.conf` : 
...
2. <u>https://dev.mysql.com/doc/refman/8.0/en/encrypted-connection-protocolsciphers.html#encrypted-connection-protocol-configuration</u> 
...
<!-- Start of picture text -->
CIS Controls:<br>Controls<br>Control  IG 1  IG 2  IG 3<br>Version<br>3.10 Encrypt Sensitive Data in Transit<br>v8  ● ●<br>Encrypt sensitive data in transit. Example implementations can include:<br>Transport Layer Security (TLS) and Open Secure Shell (OpenSSH).<br>14.4 Encrypt All Sensitive Information in Transit<br>v7  ● ●<br>Encrypt all sensitive information in transit.<br><!-- End of picture text -->
...
1. <u>https://dev.mysql.com/doc/refman/8.0/en/encrypted-connection-protocolsciphers.html#encrypted-connection-cipher-configuration</u> 
...
1. <u>https://dev.mysql.com/doc/refman/8.0/en/connection-control.html</u> 



<!-- Start of picture text -->
CIS Controls:<br>Controls Version  Control  IG 1 IG 2 IG 3<br>16 Account Monitoring and Control<br>v7<br>Account Monitoring and Control<br><!-- End of picture text -->
...
openssl list –provider If FIPS is not listed as a provider - OpenSSL is not in FIPS mode. 

4. Test - for example Try a non-FIPS TLS connection 
...
1. <u>https://docs.oracle.com/en/operating-systems/oraclelinux/8/security/configuring_fips_mode.html#configuring-fips-mode</u> 
...
1. <u>https://dev.mysql.com/doc/refman/8.0/en/password-logging.html</u> 2. <u>https://dev.mysql.com/doc/mysql-secure-deployment-guide/8.0/en/securedeployment-permissions.html</u> 
...
<!-- Start of picture text -->
Controls<br>Control  IG 1  IG 2  IG 3<br>Version<br>3.3 Configure Data Access Control Lists<br>v8  Configure data access control lists based on a user’s need to know. Apply data  ● ● ●<br>access control lists, also known as access permissions, to local and remote file<br>systems, databases, and applications.<br>14.6 Protect Information through Access Control Lists<br>Protect all information stored on systems with file system, network share,<br>v7  claims, application, or database specific access control lists. These controls will  ● ● ●<br>enforce the principle that only authorized individuals should have access to the<br>information based on their need to access the information as a part of their<br>responsibilities.<br><!-- End of picture text -->
...
1. <u>https://dev.mysql.com/doc/refman/8.0/en/error-log.html</u> 

2. <u>https://dev.mysql.com/doc/mysql-secure-deployment-guide/8.0/en/securedeployment-permissions.html</u> 



<!-- Start of picture text -->
CIS Controls:<br>Controls<br>Control  IG 1  IG 2  IG 3<br>Version<br>3.10 Encrypt Sensitive Data in Transit<br>v8  ● ●<br>Encrypt sensitive data in transit. Example implementations can include:<br>Transport Layer Security (TLS) and Open Secure Shell (OpenSSH).<br>14.6 Protect Information through Access Control Lists<br>Protect all information stored on systems with file system, network share,<br>v7  claims, application, or database specific access control lists. These controls will  ● ● ●<br>enforce the principle that only authorized individuals should have access to the<br>information based on their need to access the information as a part of their<br>responsibilities.<br><!-- End of picture text -->
...
1. <u>https://dev.mysql.com/doc/refman/8.0/en/slow-query-log.html</u> 
...
|v7|14.6Protect Information through Access Control Lists|●|●|●|
...
<!-- Start of picture text -->
<datadir>  + '/' +  <hostname>  + '-relay-bin'<br>CIS Controls:<br>Controls<br>Control  IG 1  IG 2  IG 3<br>Version<br>3.3 Configure Data Access Control Lists<br>v8  Configure data access control lists based on a user’s need to know. Apply data  ● ● ●<br>access control lists, also known as access permissions, to local and remote file<br>systems, databases, and applications.<br>14.6 Protect Information through Access Control Lists<br>Protect all information stored on systems with file system, network share,<br>v7  claims, application, or database specific access control lists. These controls will  ● ● ●<br>enforce the principle that only authorized individuals should have access to the<br>information based on their need to access the information as a part of their<br>responsibilities.<br><!-- End of picture text -->
...
1. <u>https://dev.mysql.com/doc/refman/8.0/en/query-log.html</u> 
...
1. <u>https://dev.mysql.com/doc/refman/8.0/en/encrypted-connections.html</u> 

2. <u>https://dev.mysql.com/doc/refman/8.0/en/creating-ssl-rsa-files-using-mysql.html</u> 
...
1. <u>https://dev.mysql.com/doc/refman/8.0/en/install-plugin.html</u> 
...
_3.9 Ensure 'audit_log_file' Has Appropriate Permissions (Automated)_ 
...
```
ls -l <audit_log_file> | egrep "^-([rw-]{2}-){2}---[ \t]*[0-9][ \t]*mysql[
\t]*mysql.*$"
```
...
### _3.10 Secure MySQL Keyring (Automated)_ 
...
_Keyring File Plugin (Least Secure - for pre-production testing)_ 

1. Find the `keyring_file_data` value ( _`<keyring_file_data_path>`_ ) by executing the following statement: 

```
grep -Po '(?<=^keyring_file_data=).+$' /etc/mysql/my.cnf
```

2. Verify permissions are `750` for `mysql:mysql` for _`<keyring_file_data_path>`_ 

#### _Keyring Encrypted File Plugin_ 

1. Find the `keyring_encrypted_file_data` value ( _`<keyring_encrypted_file_data_path>`_ ) by executing the following statement: 

```
grep -Po '(?<=^keyring_encrypted_file_data=).+$' /etc/mysql/my.cnf
```

2. Verify permissions are `750` for `mysql:mysql` for _`<keyring_encrypted_file_data_path>`_ 
...
#### _Keyring OKV / KMIP compatible Plugin_ 

1. Find the `keyring_okv` value ( _`<keyring_okv_path>`_ ) by executing the following statement: 

```
grep -Po '(?<=^keyring_okv=).+$' /etc/mysql/my.cnf
```

2. Verify permissions are `750` for `mysql:mysql` for _`<keyring_okv_path>`_ 

#### _Keyring Oracle Cloud Infrastructure (OCI) Vault_ 

1. Find the `keyring_oci_key_file` value ( _`<keyring_oci_key_file>`_ ) by executing the following statement: 

```
grep -Po '(?<=^keyring_oci_key_file=).+$' /etc/mysql/my.cnf
```

2. Verify permissions are `750` for `mysql:mysql` for _`<keyring_oci_key_file>`_ 

#### _Keyring Hashicorp Vault Plugin_ 

1. Find the `keyring_hashicorp_store_path` value 

   - ( _`<keyring_hashicorp_store_path>`_ ) by executing the following statement: 

```
grep -Po '(?<=^keyring_hashicorp_store_path=).+$' /etc/mysql/my.cnf
```

2. Verify permissions are `750` for `mysql:mysql` for _`<keyring_hashicorp_store_path>`_ 

#### _AWS Key Management Service_ 
...
- KMIP - <u>https://dev.mysql.com/doc/refman/8.0/en/keyring-okvplugin.html#keyring-okv-configuration</u> 

- OCI Vault - <u>https://dev.mysql.com/doc/refman/8.0/en/keyring-oci-plugin.html</u> 

- • Hashicorp - <u>https://dev.mysql.com/doc/refman/8.0/en/keyring-hashicorpplugin.html#keyring-hashicorp-plugin-configuration</u> 

- AWS - <u>https://dev.mysql.com/doc/refman/8.0/en/keyring-awsplugin.html#keyring-aws-plugin-configuration</u> 
...
1. <u>https://dev.mysql.com/doc/refman/8.0/en/keyring-system-variables.html</u> 
...
2. <u>http://dev.mysql.com/doc/relnotes/mysql/8.0/en/</u> 
...
1. <u>http://dev.mysql.com/doc/refman/8.0/en/mysql-secure-installation.html</u> 
...
1. <u>https://dev.mysql.com/doc/extending-mysql/8.0/en/adding-loadablefunction.html#loadable-function-security</u> 

2. <u>http://dev.mysql.com/doc/refman/8.0/en/serveroptions.html#option_mysqld_allow-suspicious-udfs</u> 
...
If clients have not been upgraded to 8.0.21 check the value of `local_infile` . Execute the following SQL statement: 
...
1. <u>https://dev.mysql.com/doc/refman/8.0/en/string-functions.html#function_load-file</u> 2. <u>https://dev.mysql.com/doc/refman/8.0/en/load-data.html</u> 
...
1. <u>http://dev.mysql.com/doc/refman/8.0/en/server-options.html#option_mysqld_skipgrant-tables</u> 
...
1. <u>http://dev.mysql.com/doc/refman/8.0/en/symbolic-links.html</u> 

2. <u>http://dev.mysql.com/doc/refman/8.0/en/serveroptions.html#option_mysqld_symbolic-links</u> 
...
- _4.7 Ensure the 'daemon_memcached' Plugin is Disabled (Automated)_ 
...
1. <u>http://dev.mysql.com/doc/refman/8.0/en/innodb-memcached-security.html</u> 
...
### _4.8 Ensure the 'secure_file_priv' is Configured Correctly (Automated)_ 
...
1. <u>http://dev.mysql.com/doc/refman/8.0/en/server-systemvariables.html#sysvar_secure_file_priv</u> 



<!-- Start of picture text -->
CIS Controls:<br>Controls<br>Control  IG 1  IG 2  IG 3<br>Version<br>3.3 Configure Data Access Control Lists<br>v8  Configure data access control lists based on a user’s need to know. Apply  ● ● ●<br>data access control lists, also known as access permissions, to local and remote<br>file systems, databases, and applications.<br>13 Data Protection<br>v7<br>Data Protection<br><!-- End of picture text -->
...
### _4.9 Ensure 'sql_mode' Contains 'STRICT_ALL_TABLES' (Automated)_ 
...
1. <u>https://dev.mysql.com/doc/refman/8.0/en/sql-mode.html</u> 
...
<!-- Start of picture text -->
Controls<br>Control  IG 1  IG 2  IG 3<br>Version<br>16.10 Apply Secure Design Principles in Application<br>Architectures<br>Apply secure design principles in application architectures. Secure design<br>principles include the concept of least privilege and enforcing mediation to validate<br>v8  ● ●<br>every operation that the user makes, promoting the concept of "never trust user<br>input." Examples include ensuring that explicit error checking is performed and<br>documented for all input, including for size, data type, and acceptable ranges or<br>formats. Secure design also means minimizing the application infrastructure attack<br>surface, such as turning off unprotected ports and services, removing unnecessary<br>programs and files, and renaming or removing default accounts.<br><!-- End of picture text -->
...
- _4.10 Use MySQL TDE for At-Rest Data Encryption (Automated)_ 
...
1. <u>https://dev.mysql.com/doc/refman/8.0/en/innodb-data-encryption.html</u> 

2. <u>https://dev.mysql.com/doc/refman/8.0/en/server-systemvariables.html#sysvar_table_encryption_privilege_check</u> 

3. <u>https://dev.mysql.com/doc/refman/8.0/en/create-database.html</u> 

4. <u>https://dev.mysql.com/doc/refman/8.0/en/replication-binlog-encryption.html</u> 

5. <u>https://dev.mysql.com/doc/refman/8.0/en/audit-log-loggingconfiguration.html#audit-log-file-encryption</u> 

6. <u>https://dev.mysql.com/doc/mysql-enterprise-backup/8.0/en/meb-encryptedinnodb.html</u> 
...
<!-- Start of picture text -->
Controls<br>Control  IG 1  IG 2  IG 3<br>Version<br>3.11 Encrypt Sensitive Data at Rest<br>Encrypt sensitive data at rest on servers, applications, and databases containing<br>sensitive data. Storage-layer encryption, also known as server-side encryption,<br>v8  ● ●<br>meets the minimum requirement of this Safeguard. Additional encryption methods<br>may include application-layer encryption, also known as client-side encryption,<br>where access to the data storage device(s) does not permit access to the plain-text<br>data.<br>14.8 Encrypt Sensitive Information at Rest<br>v7  Encrypt all sensitive information at rest using a tool that requires a secondary  ●<br>authentication mechanism not integrated into the operating system, in order to<br>access the information.<br><!-- End of picture text -->
...
1. <u>https://dev.mysql.com/doc/refman/8.0/en/information-schema-user-privilegestable.html</u> 

2. <u>https://dev.mysql.com/doc/refman/8.0/en/reserved-accounts.html</u> 
...
<!-- Start of picture text -->
Controls<br>Control  IG 1  IG 2  IG 3<br>Version<br>5.4 Restrict Administrator Privileges to Dedicated<br>Administrator Accounts<br>v8  ● ● ●<br>Restrict administrator privileges to dedicated administrator accounts on<br>enterprise assets. Conduct general computing activities, such as internet browsing,<br>email, and productivity suite use, from the user’s primary, non-privileged account.<br>4.1 Maintain Inventory of Administrative Accounts<br>v7  Use automated tools to inventory all administrative accounts, including domain  ● ●<br>and local accounts, to ensure that only authorized individuals have elevated<br>privileges.<br>14.6 Protect Information through Access Control Lists<br>Protect all information stored on systems with file system, network share, claims,<br>v7  ● ● ●<br>application, or database specific access control lists. These controls will enforce the<br>principle that only authorized individuals should have access to the information<br>based on their need to access the information as a part of their responsibilities.<br><!-- End of picture text -->
...
1. <u>https://dev.mysql.com/doc/refman/8.0/en/privileges-provided.html#priv_file</u> 

2. <u>https://dev.mysql.com/doc/refman/8.0/en/privileges-provided.html#privilegesprovided-summary</u> 
...
<!-- Start of picture text -->
Controls<br>Control  IG 1  IG 2  IG 3<br>Version<br>5.4 Restrict Administrator Privileges to Dedicated<br>Administrator Accounts<br>v8  ● ● ●<br>Restrict administrator privileges to dedicated administrator accounts on<br>enterprise assets. Conduct general computing activities, such as internet browsing,<br>email, and productivity suite use, from the user’s primary, non-privileged account.<br>14.6 Protect Information through Access Control Lists<br>Protect all information stored on systems with file system, network share,<br>v7  claims, application, or database specific access control lists. These controls will  ● ● ●<br>enforce the principle that only authorized individuals should have access to the<br>information based on their need to access the information as a part of their<br>responsibilities.<br><!-- End of picture text -->
...
1. <u>https://dev.mysql.com/doc/refman/8.0/en/privileges-provided.html#priv_process</u> 
...
1. <u>https://dev.mysql.com/doc/refman/8.0/en/privileges-provided.html#priv_super</u> 2. <u>https://dev.mysql.com/doc/refman/8.0/en/privileges-provided.html#privilegesprovided-summary</u> 
...
1. <u>https://dev.mysql.com/doc/refman/8.0/en/privileges-provided.html#priv_shutdown</u> 2. <u>https://dev.mysql.com/doc/refman/8.0/en/privileges-provided.html#privilegesprovided-summary</u> 
...
1. <u>https://dev.mysql.com/doc/refman/8.0/en/privileges-provided.html#priv_createuser</u> 
...
1. <u>https://dev.mysql.com/doc/refman/8.0/en/privileges-provided.html#priv_grantoption</u> 
...
1. <u>https://dev.mysql.com/doc/refman/8.0/en/privileges-</u> 

   - <u>provided.html#priv_replication-slave</u> 
...
##### 1. <u>https://dev.mysql.com/doc/refman/8.0/en/create-procedure.html</u> 
...
<!-- Start of picture text -->
Controls<br>Control  IG 1  IG 2  IG 3<br>Version<br>16.10 Apply Secure Design Principles in Application<br>Architectures<br>Apply secure design principles in application architectures. Secure design<br>principles include the concept of least privilege and enforcing mediation to validate<br>v8  ● ●<br>every operation that the user makes, promoting the concept of "never trust user<br>input." Examples include ensuring that explicit error checking is performed and<br>documented for all input, including for size, data type, and acceptable ranges or<br>formats. Secure design also means minimizing the application infrastructure attack<br>surface, such as turning off unprotected ports and services, removing unnecessary<br>programs and files, and renaming or removing default accounts.<br>14.6 Protect Information through Access Control Lists<br>v7  Protect all information stored on systems with file system, network share, claims,  ● ● ●<br>application, or database specific access control lists. These controls will enforce the<br>principle that only authorized individuals should have access to the information<br>based on their need to access the information as a part of their responsibilities.<br><!-- End of picture text -->
...
<!-- Start of picture text -->
Controls<br>Control  IG 1  IG 2  IG 3<br>Version<br>8.2 Collect Audit Logs<br>v8  ● ● ●<br>Collect audit logs. Ensure that logging, per the enterprise’s audit log<br>management process, has been enabled across enterprise assets.<br>6.2 Activate audit logging<br>v7  ● ● ●<br>Ensure that local logging has been enabled on all systems and networking<br>devices.<br><!-- End of picture text -->
...
1. <u>https://dev.mysql.com/doc/refman/8.0/en/binary-log.html</u> 

2. <u>https://dev.mysql.com/doc/refman/8.0/en/replication-options-binary-log.html</u> 
...
1. <u>https://dev.mysql.com/doc/refman/8.0/en/server-systemvariables.html#sysvar_log_error_verbosity</u> 
...
<!-- Start of picture text -->
Controls<br>Control  IG 1  IG 2  IG 3<br>Version<br>8.5 Collect Detailed Audit Logs<br>v8  Configure detailed audit logging for enterprise assets containing sensitive data.  ● ●<br>Include event source, date, username, timestamp, source addresses, destination<br>addresses, and other useful elements that could assist in a forensic investigation.<br>6.3 Enable Detailed Logging<br>v7  Enable system logging to include detailed information such as an event source,  ● ●<br>date, user, timestamp, source addresses, destination addresses, and other useful<br>elements.<br><!-- End of picture text -->
...
1. <u>https://dev.mysql.com/doc/refman/8.0/en/password-logging.html</u> 

2. <u>https://dev.mysql.com/doc/refman/8.0/en/serveroptions.html#option_mysqld_log-raw</u> 
...
- _6.5 Ensure Audit Filters Capture Connection Attempts (Manual)_ 
...
To assess this recommendation, execute the following SQL statements: Evaluate the filters: 
...
1. <u>https://dev.mysql.com/doc/refman/8.0/en/audit-log-filtering.html</u> 2. <u>https://dev.mysql.com/doc/refman/8.0/en/audit-log.html</u> 
...
<u>https://dev.mysql.com/doc/refman/8.0/en/audit-log-legacy-filtering.html</u> 



<!-- Start of picture text -->
CIS Controls:<br>Controls<br>Control  IG 1  IG 2  IG 3<br>Version<br>8.5 Collect Detailed Audit Logs<br>v8  Configure detailed audit logging for enterprise assets containing sensitive data.  ● ●<br>Include event source, date, username, timestamp, source addresses, destination<br>addresses, and other useful elements that could assist in a forensic investigation.<br>6.3 Enable Detailed Logging<br>v7  Enable system logging to include detailed information such as an event source,  ● ●<br>date, user, timestamp, source addresses, destination addresses, and other useful<br>elements.<br><!-- End of picture text -->
...
- _6.6 Ensure ALL Events are Audited (Automated)_ 
...
##### 1. <u>https://dev.mysql.com/doc/refman/8.0/en/audit-log-filtering.html</u> 
...
### _6.7 Set audit_log_strategy to SYNCHRONOUS or SEMISYNCRONOUS (Automated)_ 
...
1. <u>https://dev.mysql.com/doc/refman/8.0/en/audit-logreference.html#sysvar_audit_log_strategy</u> 
...
<!-- Start of picture text -->
CIS Controls:<br>Controls<br>Control  IG 1  IG 2  IG 3<br>Version<br>8.5 Collect Detailed Audit Logs<br>v8  Configure detailed audit logging for enterprise assets containing sensitive data.  ● ●<br>Include event source, date, username, timestamp, source addresses, destination<br>addresses, and other useful elements that could assist in a forensic investigation.<br><!-- End of picture text -->
...
- _6.8 Ensure the Audit Plugin Can't be Unloaded (Automated)_ 
...
1. <u>https://dev.mysql.com/doc/refman/8.0/en/audit-logreference.html#option_mysqld_audit-log</u> 
...
- _7.1 Ensure default_authentication_plugin is Set to a Secure Option (Automated)_ 
...
1. <u>https://dev.mysql.com/doc/refman/8.0/en/upgrading-from-previousseries.html#upgrade-caching-sha2-password-compatibility-issues</u> 

2. <u>https://dev.mysql.com/doc/refman/8.0/en/authentication-plugins.html</u> 
...
<!-- Start of picture text -->
INSTALL COMPONENT 'file://component_validate_password';<br>Edit the  my.cnf  file to define and enforce a password policy<br>[mysqld]<br>validate_password.dictionary_file=/usr/share/dict/words<br>validate_password.length=10<br>validate_password.number_count=2<br>References:<br>1.  https://dev.mysql.com/doc/refman/8.0/en/assigning-passwords.html<br>2.  https://dev.mysql.com/doc/refman/8.0/en/validate-password-transitioning.html<br>3.  https://dev.mysql.com/doc/refman/8.0/en/validate-password.html<br>CIS Controls:<br>Controls<br>Control  IG 1  IG 2  IG 3<br>Version<br>5.2 Use Unique Passwords<br>v8  Use unique passwords for all enterprise assets. Best practice implementation  ● ● ●<br>includes, at a minimum, an 8-character password for accounts using MFA and a<br>14-character password for accounts not using MFA.<br>4.4 Use Unique Passwords<br>v7  Where multi-factor authentication is not supported (such as local administrator,  ● ●<br>root, or service accounts), accounts will use passwords that are unique to that<br>system.<br><!-- End of picture text -->
...
1. <u>https://dev.mysql.com/doc/refman/8.0/en/password-management.html</u> 

2. <u>https://dev.mysql.com/doc/refman/8.0/en/expired-password-handling.html</u> 
...
1. <u>https://dev.mysql.com/doc/refman/8.0/en/validate-password.html</u> 
...
<!-- Start of picture text -->
SELECT user, host FROM mysql.user WHERE host = '%';<br><!-- End of picture text -->
...
**Note:** As an alternative, you may execute the `mysql_secure_installation` utility. **References:** 

1. <u>https://dev.mysql.com/doc/refman/8.0/en/mysql-secure-installation.html</u> 

2. <u>https://dev.mysql.com/doc/refman/8.0/en/default-privileges.html</u> 

3. <u>https://dev.mysql.com/doc/refman/8.0/en/proxy-users.html#proxy-users-conflicts</u> 
...
2. <u>https://dev.mysql.com/doc/refman/8.0/en/connection-options.html</u> 

3. <u>https://dev.mysql.com/doc/refman/8.0/en/server-systemvariables.html#sysvar_require_secure_transport</u> 
...
<!-- Start of picture text -->
Controls<br>Control  IG 1  IG 2  IG 3<br>Version<br>3.10 Encrypt Sensitive Data in Transit<br>v8  ● ●<br>Encrypt sensitive data in transit. Example implementations can include:<br>Transport Layer Security (TLS) and Open Secure Shell (OpenSSH).<br>14.4 Encrypt All Sensitive Information in Transit<br>v7  ● ●<br>Encrypt all sensitive information in transit.<br><!-- End of picture text -->
...
2. <u>https://dev.mysql.com/doc/refman/8.0/en/alter-user.html#alter-user-tls</u> 

3. <u>https://dev.mysql.com/doc/refman/8.0/en/connectionoptions.html#option_general_ssl</u> 
...
1. <u>https://dev.mysql.com/doc/refman/8.0/en/user-resources.html</u> 2. <u>https://dev.mysql.com/doc/refman/8.0/en/connection-interfaces.html#connectioninterfaces-volume-management</u> 
...
1. <u>https://dev.mysql.com/doc/refman/8.0/en/change-replication-source-to.html</u> 2. <u>https://dev.mysql.com/doc/refman/8.0/en/change-master-to.html</u> 
...
<!-- Start of picture text -->
CIS Controls:<br>Controls<br>Control  IG 1  IG 2  IG 3<br>Version<br>13.9 Deploy Port-Level Access Control<br>v8  Deploy port-level access control. Port-level access control utilizes 802.1x, or  ●<br>similar network access control protocols, such as certificates, and may<br>incorporate user and/or device authentication.<br><!-- End of picture text -->
...
_9.3 Ensure 'master_info_repository' is Set to 'TABLE' (Automated)_ 
...
1. <u>https://dev.mysql.com/doc/refman/8.0/en/replication-optionsreplica.html#sysvar_master_info_repository</u> 

Page 203 

Internal Only - General 

### _9.4 Ensure 'super_priv' is Not Set to 'Y' for Replication Users (Automated)_ 
...
1. <u>https://dev.mysql.com/doc/refman/8.0/en/privileges-provided.html#priv_super</u> 2. <u>https://dev.mysql.com/doc/mysql-shell/8.0/en/deploying-innodb-replicasets.html</u> 
...
1. <u>https://dev.mysql.com/doc/refman/8.0/en/group-replication-secure-socket-layersupport-ssl.html</u> 
...
<!-- Start of picture text -->
• From 8.0.22 on:<br>select @@group_replication_ip_allowlist<br>• Prior to 8.0.22:<br><!-- End of picture text -->



<!-- Start of picture text -->
select @@group_replication_ip_whitelist;<br><!-- End of picture text -->
...
1. <u>https://dev.mysql.com/doc/mysql-shell/8.0/en/mysql-innodb-cluster-securing.html</u> 2. <u>https://dev.mysql.com/doc/refman/8.0/en/group-replication-ip-addresspermissions.html</u> 
...
|3.9|Ensure 'audit_log_file' Has Appropriate Permissions<br>(Automated)|||
...
|4.7|Ensure the 'daemon_memcached' Plugin is Disabled<br>(Automated)|||
|4.8|Ensure the 'secure_file_priv' is Configured Correctly<br>(Automated)|||
|4.9|Ensure 'sql_mode' Contains 'STRICT_ALL_TABLES'<br>(Automated)|||
|4.10|Use MySQL TDE for At-Rest Data Encryption<br>(Automated)|||
|**5**|**MySQL Permissions**|||
...
|6.5|Ensure Audit Filters Capture Connection Attempts<br>(Manual)|||
|6.6|Ensure ALL Events are Audited (Automated)|||
|6.7|Set audit_log_strategy to SYNCHRONOUS or<br>SEMISYNCRONOUS (Automated)|||
|6.8<br>**7**|Ensure the Audit Plugin Can't be Unloaded (Automated)<br>**Authentication**|||
...
|---|---|---|---|
|7.1|Ensure default_authentication_plugin is Set to a Secure<br>Option (Automated)|||
...
|9.3|Ensure 'master_info_repository' is Set to 'TABLE'<br>(Automated)|||
...
<!-- Start of picture text -->
CIS Benchmark Recommendation  Set<br>Correctly<br>Yes  No<br>9.4  Ensure 'super_priv' is Not Set to 'Y' for Replication Users   <br>(Automated)<br>10  MySQL InnoDB Cluster / Group Replication<br>10.1  Ensure All Group Replication Traffic is Secured (Manual)   <br>10.2  Allowlist Approved Servers Belonging to a MySQL   <br>InnoDB Cluster (Manual)<br><!-- End of picture text -->
...
|**Date**<br>**Version**<br>**Changes for this version**|
|---|
|Apr 14, 2021<br>1.0.0<br>Add section - Use dual password to<br>increase frequency of application<br>password rotation. (Ticket 10358)|
|Apr 14, 2021<br>1.0.0<br>If connection delays are enable monitor<br>(Ticket 10362)|
|Apr 14, 2021<br>1.0.0<br>Add section - limit host IP using bind<br>(Ticket 10363)|
|Apr 14, 2021<br>1.0.0<br>Require specific TLS versions (Ticket<br>10364)|
|Apr 14, 2021<br>1.0.0<br>Add Section on -  Enabling TDE<br>encryption (Ticket 10365)|
|Apr 14, 2021<br>1.0.0<br>Add to dual password audit the following<br>SQL (Ticket 10373)|
|Apr 14, 2021<br>1.0.0<br>Add section - Set Password Reuse<br>Policy (Ticket 10356)|
|Apr 14, 2021<br>1.0.0<br>Add section - Lock accounts if not in<br>current use. (Ticket 10359)|
|Apr 14, 2021<br>1.0.0<br>Add section - Implement Connection<br>Delays to defend against brute<br>authentication attacks (Ticket 10361)|
|Apr 14, 2021<br>1.0.0<br>Create Section - Timeout authentication<br>for interactive and non-interactive<br>sessions (Ticket 10383)|
|Apr 14, 2021<br>1.0.0<br>Add Section - Set Account Resource<br>Limits (Ticket 10384)|
|Apr 14, 2021<br>1.0.0<br>Add section - Ensure MySQL Cluster<br>requires SSL Mode (Ticket 10386)|
|Apr 14, 2021<br>1.0.0<br>Add Section - Optionally specify a<br>whitelist of approved servers that belong<br>to the MySQL InnoDB Cluster (Ticket<br>10393)|
...
|**Date**<br>**Version**|**Changes for this version**|
|---|---|
|Apr 14, 2021<br>1.0.0|Change title and update content (Ticket<br>10323)|
|Apr 14, 2021<br>1.0.0|Should mention reserved users (new to<br>8.0) (Ticket 10294)|
|Apr 14, 2021<br>1.0.0|Shouldn't this be level 1? (Ticket 10295)|
|Apr 14, 2021<br>1.0.0|Not sufficient to just check location of<br>the data directory (Ticket 10282)|
|Apr 14, 2021<br>1.0.0|Update References (Ticket 10286)|
|Apr 14, 2021<br>1.0.0|Update Env Ref (Ticket 10287)|
|Apr 14, 2021<br>1.0.0|check require_secure_transport (Ticket<br>10327)|
|Apr 14, 2021<br>1.0.0|Need to rewrite this entirely.  Old and<br>dated. (Ticket 10312)|
|Apr 14, 2021<br>1.0.0|general_log_file should be off. (Ticket<br>10313)|
|Apr 14, 2021<br>1.0.0|Should show all files for ssl (Ticket<br>10314)|
|Apr 14, 2021<br>1.0.0|Add encryption to this (Ticket 10316)|
|Apr 14, 2021<br>1.0.0|keyring_file_data is not a best practice<br>(Ticket 10317)|
|Apr 14, 2021<br>1.0.0|Remove section - there is no test<br>database in 5.7 nor 8 (Ticket 10318)|
|Apr 14, 2021<br>1.0.0|In 8 super replaced by dynamic privy<br>(Ticket 10321)|
|Apr 14, 2021<br>1.0.0|No longer in 8.0 - remove section<br>Ensure 'secure_auth' is set to 'ON'<br>(Ticket 10324)|
|Apr 14, 2021<br>1.0.0|need to rewrite 6.5-6.7 - this is legacy<br>modes - too course grained etc. (Ticket<br>10322)|
...
|**Date**<br>**Version**|**Changes for this version**|
|---|---|
|Apr 14, 2021<br>1.0.0|Remove section 'sql_mode' contains ...<br>not in 8 (Ticket 10325)|
|Apr 14, 2021<br>1.0.0|Consider a more comprehsive SQL<br>statement to audit admin privy (Ticket<br>10320)|
|Apr 14, 2021<br>1.0.0|Should Group Replication be added to<br>this section? (Ticket 10328)|
|Apr 14, 2021<br>1.0.0|Better to set global policy than per user.<br>(Ticket 10296)|
|Apr 14, 2021<br>1.0.0|MySQL Shell needs to be added (Ticket<br>10293)|
|Apr 14, 2021<br>1.0.0|MySQL Enterprise Backup (Ticket<br>10288)|
|Apr 14, 2021<br>1.0.0|First reference link is not existing (Ticket<br>12331)|
|Apr 14, 2021<br>1.0.0|MySQL 8.0 Benchmark Final Version<br>(Ticket 10405)|
|Jun 10, 2021<br>1.1.0|Typo in Default Value (Ticket 13100)|
|Jun 28, 2021<br>1.1.0|Rows returned by the regular<br>expression in the query will include<br>'ssl_cipher' (Ticket 12784)|
|Jul 1, 2021<br>1.1.0|validate password plugin is deprecated<br>(Ticket 12774)|
|Jul 1, 2021<br>1.1.0|There is no 'source_info_repository' in<br>8.0.23 (Ticket 13011)|
|Jul 2, 2021<br>1.1.0|Error in the remediation procedures<br>(Ticket 12997)|
|Jul 13, 2021<br>1.1.0|log_error can't be empty (Ticket 13288)|
|Jul 13, 2021<br>1.1.0|Internal users which are locked by<br>default should be excluded (Ticket<br>13289)|
...
|**Date**|**Version**<br>**Changes for this version**|
|---|---|
|Jul 14, 2021|1.1.0<br>Map to Controls v8 (Ticket 13307)|
|Nov 3, 2021|1.2.0<br>Update artifact to include example<br>databases along with test (Ticket<br>14089)|
|Apr 28, 2022|1.2.0<br>Change 'FALSE' in the audit procedure<br>to 'OFF' (Ticket 14274)|
|May 4, 2022|1.2.0<br>Add recommendation to ensure MySQL<br>is run in Jail or Chroot. (Ticket 14254)|
|May 4, 2022|1.2.0<br>Delete duplicate recommendation for<br>password complexity (Ticket 13400)|
|May 4, 2022|1.2.0<br>Revise MySQL Permissions<br>recommendations to be similar to the<br>recommendation to limit the use of<br>'SUPER' (Ticket 14622)|
|May 6, 2022|1.2.0<br>Alter duplicate query suggestion 7.6<br>Ensure No Users Have Wildcard<br>Hostnames and 9.5 Ensure No<br>Replication Users Have Wildcard<br>Hostnames (Ticket 15104)|
|May 12, 2022|1.2.0<br>Closing quote in second Audit<br>procedure missing (Ticket 13699)|
|May 12, 2022|1.2.0<br>Typo in Description section (Ticket<br>13701)|
|Mar 29, 2023|1.2.1<br>Republished as v1.2.1 to address an<br>AAC bug.|
|Oct 12, 2023|1.3.0<br>2.7  Ensure 'password_lifetime' is Less<br>Than or Equal to '365' have<br>contradictory statement and query<br>(Ticket 17851)|
|Oct 12, 2023|1.3.0<br>3.5 - Ensure 'relay_log_basename' Files<br>Have Appropriate Permissions - Errors<br>in third Audit script (Ticket 16419)|
...
|**Date**<br>**Version**|**Changes for this version**|
|---|---|
|Oct 12, 2023<br>1.3.0|3.4 - Ensure 'slow_query_log' Has<br>Appropriate Permissions - Errors in third<br>Audit script (Ticket 16418)|
|Oct 12, 2023<br>1.3.0|MySQL Allow Suspicious UDF's is<br>assessing Fail Even when the<br>parameter is FALSE. (Ticket 18686)|
|Oct 12, 2023<br>1.3.0|May not evaluate correctly when `allow-<br>suspicious-udfs` is not present in the<br>`my.cnf`. (Ticket 17789)|
|Oct 12, 2023<br>1.3.0|CIS hardening parameters are giving<br>false positive after remediation. (Ticket<br>17766)|
|Nov 25, 2024<br>1.4.0|Missing remediation for<br>table_encryption_privilege_check<br>(Ticket 20691)|
|Nov 25, 2024<br>1.4.0|ADD - Ensure Proper Use Of<br>'SET_ANY_DEFINER' (Ticket 23146)|
|Nov 25, 2024<br>1.4.0|Add - Ensure Proper Use Of<br>ALLOW_NONEXISTENT_DEFINER<br>(Ticket 23147)|
|Dec 4, 2024<br>1.4.0|Ensure mysql audit log has appro.<br>permission is coming as fail even with<br>CIS mentioned permissions (Ticket<br>20969)|
|Dec 9, 2024<br>1.4.0|Recommendation not precise enough<br>(Ticket 15889)|
|Mar 7, 2025<br>1.5.0|Artifact 3.7.2 - does not appear to be<br>prepending datadir string to relative<br>filepath (Ticket 21812)|
|Aug 18, 2025<br>1.5.0|Backported recommendation for FIPS<br>140-2 Open_SSL Cryptography|
...
|**Date**|**Version**|**Changes for this version**|
|---|---|---|
|Sep 8, 2025|1.5.0|Backported changes to<br>recommendation for ensuring<br>passwords are set for all MySQL<br>accounts|
|Sep 15, 2025|1.5.0|'have_ssl' and 'have_openssl' no longer<br>used (Ticket 24082)|
|Sep 30, 2025|1.5.0|Update Published|
