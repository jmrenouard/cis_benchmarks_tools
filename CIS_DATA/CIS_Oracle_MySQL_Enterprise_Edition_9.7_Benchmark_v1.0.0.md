# CIS Oracle MySQL Enterprise Edition 9.7 Benchmark 
...
|2.1.2 Verify Backups are Good (Manual) .................................................................................. 37|
|2.1.3 Secure Backup Credentials (Manual) .............................................................................. 38|
|2.1.4 The Backups Should Be Properly Secured (Manual) ...................................................... 39|
|2.1.5 Point-in-Time Recovery (Automated) ............................................................................... 41<br>|
|2.1.6 Disaster Recovery (DR) Plan (Manual) ............................................................................ 43|
|<br>2.1.7 Backup of Configuration and Related Files (Manual) ...................................................... 45|
|**2.2 Data Encryption .............................................................................................................................. 46**|
|2.2.1 Ensure Binary and Relay Logs are Encrypted (Automated) ............................................ 47|
|2.3 Dedicate the Machine Running MySQL (Manual) ............................................................... 49|
|2.4 Do Not Specify Passwords in the Command Line (Manual) ............................................... 51|
...
|2.8 Ensure Password Resets Require Strong Passwords (Automated) ................................... 59|
|2.9 Require Current Password for Password Reset (Automated) ............................................ 61|
|2.10 Use Dual Passwords to Enable Higher Frequency Password Rotation (Manual) ............ 63<br>|
|2.11 Lock Out Accounts if Not Currently in Use (Manual) ........................................................ 66<br>2.12 Ensure AES Encryption Mode for AES_ENCRYPT/AES_DECRYPT is Configured<br>Correctly (Automated) ............................................................................................................... 68|
|2.13 Ensure Socket Peer-Credential Authentication is Used Appropriately (Manual) .............. 70|
|2.14 Ensure MySQL is Bound to an IP Address (Automated) .................................................. 72<br>|
|2.15 Limit Accepted Transport Layer Security (TLS) Versions (Automated) ............................ 74|
|<br>2.16 Require Client-Side Certificates (X.509) (Automated) ...................................................... 76|
|2.17 Ensure Only Approved Ciphers are Used (Automated) .................................................... 78|
|218 Implement Connection Delays to Limit Failed Login Attempts (Automated)  80|
|.          ....................<br>2.19 Ensure FIPS 140-3 OpenSSL Cryptography Is Used (Manual) ........................................ 82|
|**3 File Permissions .................................................................................................................... 87**|
|3.1 Ensure 'datadir' Has Appropriate Permissions (Automated) ............................................... 88|
|3.2 Ensure 'log_bin_basename' Files Have Appropriate Permissions (Automated) ................ 90<br>|
...
|<br>3.9 Ensure 'auditlogfile' Has Appropriate Permissions (Automated) .................................. 107|
|__<br>3.10 Secure MySQL Keyring (Automated) .............................................................................. 109|
|Components .......................................................................................................................... 110|
|Keyring File Component_(Least Secure — for pre-production testing)_................................ 110|
|<br>Keyring Encrypted File Component ...................................................................................... 110|
|<br>Keyring KMIP Component .................................................................................................... 110|
|Keyring OCI Vault Component.............................................................................................. 111<br>|
|Keyring HashiCorp Vault Component ................................................................................... 111|
|<br>Keyring AWS Component ..................................................................................................... 111|
|<br>Legacy Plugins (Superseded — audit only if components are not in use) ........................... 111|
|Keyring File Plugin_(Superseded)_......................................................................................... 111|
|Keyring Encrypted File Plugin_(Superseded)_........................................................................ 112|
|<br>Keyring OKV / KMIP Plugin_(Superseded)_........................................................................... 112|
|<br>Keyring OCI Vault Plugin_(Superseded)_............................................................................... 112|
...
|Keyring HashiCorp Vault Plugin_(Deprecated)_..................................................................... 112<br>|
|---|
|Keyring AWS Plugin_(Deprecated)_....................................................................................... 112|
|<br>MySQL Keyring Remediation Procedures ............................................................................ 113|
|**4 General ................................................................................................................................. 115**|
|4.1 Ensure the Latest Security Patches are Applied (Manual) ............................................... 116|
|4.2 Ensure Example or Test Databases are Not Installed on Production Servers (Automated)<br>................................................................................................................................................. 118|
|4.3 Ensure 'allow-suspicious-udfs' is Set to 'OFF' (Automated) .............................................. 120|
|4.4 Harden Usage for 'local_infile' on MySQL Clients (Automated) ....................................... 122|
|4.5 Ensure 'mysqld' is Not Started With '--skip-grant-tables' (Automated) ............................. 124|
|4.6 Ensure Symbolic Links are Disabled (Automated) ............................................................ 126<br>|
|4.7 Ensure the 'securefilepriv' is Configured Correctly (Automated) .................................. 128|
|__<br>4.8 Ensure 'sql_mode' Contains 'STRICT_ALL_TABLES' (Automated) ................................. 130|
|4.9 Use MySQL TDE for at rest data encryption (Automated) ................................................ 132|
|**5 MySQL Permissions ............................................................................................................ 135**|
|5.1 Ensure Only Administrative Users Have Full Database Access (Manual)........................ 136|
|5.2 Ensure 'FILE' is Not Granted to Non-Administrative Users (Manual) ............................... 138|
|<br>5.3 Ensure 'PROCESS' is Not Granted to Non-Administrative Users (Manual) ..................... 140|
|5.4 Ensure 'SUPER' is Not Granted to Non-Administrative Users (Manual) .......................... 142|
|5.5 Ensure 'SHUTDOWN' is Not Granted to Non-Administrative Users (Manual).................. 144|
|5.6 Ensure 'CREATE USER' is Not Granted to Non-Administrative Users (Manual) ............. 146<br>|
|5.7 Ensure 'GRANT OPTION' is Not Granted to Non-Administrative Users (Manual) ........... 148|
|<br>5.8 Ensure 'REPLICATION SLAVE' is Not Granted to Non-Administrative Users (Manual) .. 150<br>5.9 Ensure DML/DDL Grants are Limited to Specific Databases and Users (Manual) .......... 152|
|5.10 Securely Define Stored Procedures and Functions DEFINER and INVOKER (Manual)154<br>5.11 Ensure Proper Use Of 'SET_ANY_DEFINER' (Manual) ................................................. 156|
|5.12 Ensure Proper Use Of 'ALLOW_NONEXISTENT_DEFINER' (Manual) ......................... 158|
|**6 Auditing and Logging ......................................................................................................... 160**|
|<br>6.1 Ensure 'log_error' is configured correctly (Automated) ..................................................... 161|
|6.2 Ensure Log Files are Stored on a Non-System Partition (Automated) ............................. 163|
|6.3 Ensure 'log_error_verbosity' is Set to '2' (Automated) ...................................................... 165<br>|
|6.4 Ensure 'log-raw' is Set to 'OFF' (Automated) .................................................................... 167|
|<br>6.5 Ensure Audit Filters Capture Connection Attempts (Manual) ........................................... 169|
|<br>6.6 Ensure ALL Events are Audited (Automated) ................................................................... 172|
|6.7 Set audit_log_strategy to SYNCHRONOUS or SEMISYNCHRONOUS (Automated) ..... 174|
|6.8 Ensure the Audit Plugin Can't be Unloaded (Automated) ................................................. 176|
|**7 Authentication ..................................................................................................................... 178**<br>|
|7.1 Ensure your 'authentication_policy' is Set to a Secure Option (Automated)..................... 179|
|<br>7.2 Ensure Passwords are Not Stored in the Global Configuration (Automated) ................... 181|
|7.3 Ensure Passwords are Set for All MySQL Accounts (Automated) ................................... 183|
|7.4 Set 'default_password_lifetime' to Require a Yearly Password Change (Automated) ..... 185<br>|
|7.5 Ensure Password Complexity Policies are in Place (Automated) ..................................... 187|
|<br>7.6 Ensure No Users Have Wildcard Hostnames (Automated) .............................................. 190|
|<br>7.7 Ensure No Anonymous Accounts Exist (Automated) ........................................................ 191|
|<br>7.8 Ensure 'caching_sha2_password' uses and enforces 'PBKDF2-SHA512' password storage|
|(Manual) ................................................................................................................................... 193|
|<br>7.9 Ensure 'activateallrolesonlogin' is disabled and mandatory role activation is explicitly|
|____<br>controlled (Manual) .................................................................................................................. 198|
|<br>7.10 Ensure Dynamic Data Masking is configured for sensitive columns (Manual) ............... 201<br>7.11 Ensure Multifactor Authentication is Required for Administrative and Other Designated<br>Accounts (Manual) ................................................................................................................... 205|
|<br>7.12 Ensure WebAuthn is Used for Phishing-Resistant Authentication Where Required|
|<br>(Manual) ................................................................................................................................... 207|
...
|**8 Network ................................................................................................................................. 209**|
|---|
|8.1 Ensure 'require_secure_transport' is Set to 'ON' (Automated) ......................................... 210|
|8.2 Ensure 'ssl_type' is set to 'X509' or 'SPECIFIED' for all remote users (Automated) ........ 212<br>8.3 Set Maximum Connection Limits for Server and per User (Manual) ................................ 214|
|**9 Replication ........................................................................................................................... 216**|
|9.1 Ensure Replication Traffic is Secured (Manual) ................................................................ 217|
|9.2 Ensure 'SOURCE_SSL_VERIFY_SERVER_CERT' is Set to 'YES' or '1' (Automated) ... 218<br>9.3 Ensure 'super_priv' is Not Set to 'Y' for Replication Users (Automated) ........................... 220|
|**10 MySQL InnoDB Cluster / Group Replication .................................................................. 223**|
|10.1 Ensure All Group Replication Traffic is Secured (Manual).............................................. 224<br>10.2 Allowlist Approved Servers Belonging to a MySQL InnoDB Cluster (Manual) ............... 226|
|**_Appendix: Summary Table .......................................................................................... 228_**|
|**_Appendix: CIS Controls v7 IG 1 Mapped Recommendations ................................. 235_**|
|**_Appendix: CIS Controls v7 IG 2 Mapped Recommendations ................................. 237_**|
|**_Appendix: CIS Controls v7 IG 3 Mapped Recommendations ................................. 241_**|
|**_Appendix: CIS Controls v7 Unmapped Recommendations .................................... 245_**|
|**_Appendix: CIS Controls v8 IG 1 Mapped Recommendations ................................. 246_**|
|**_Appendix: CIS Controls v8 IG 2 Mapped Recommendations ................................. 249_**|
|**_Appendix: CIS Controls v8 IG 3 Mapped Recommendations ................................. 253_**|
|**_Appendix: CIS Controls v8 Unmapped Recommendations .................................... 257_**|
|**_Appendix: Change History .......................................................................................... 258_**|
...
This document, CIS Oracle MySQL Enterprise Edition 9.7 Benchmark, provides prescriptive guidance for establishing a secure configuration posture for MySQL Enterprise Edition 9.7. This guide was tested against MySQL Enterprise Edition 9.7 running on Oracle Linux, but applies to other Linux distributions as well. To obtain the latest version of this guide, please visit http://benchmarks.cisecurity.org. If you have questions, comments, or have identified ways to improve this guide, please write us at <u>feedback@cisecurity.org.</u> 

#### **Intended Audience** 

This document is intended for system and application administrators, security specialists, auditors, help desk, and platform deployment personnel who plan to develop, deploy, assess, or secure solutions that incorporate Oracle MySQL Enterprise Edition 9.7. 
...
Items in this profile apply to MySQL Enterprise Edition 9.7 running on Linux and intend to: 
...
This profile extends the "Level 1 - MySQL RDBMS on Linux" profile. Items in this profile apply to MySQL Enterprise Edition 9.7 running on Linux and exhibit one or more of the following characteristics: 
...
Items in this profile apply to MySQL Enterprise Edition 9.7 and intend to: 
...
This profile extends the "Level 1 - MySQL RDBMS" profile. Items in this profile apply to MySQL Enterprise Edition 9.7 and exhibit one or more of the following characteristics: 
...
If `--encrypt-password` is not included the backup or is not encrypted, this is a fail. 
...
1. <u>https://dev.mysql.com/doc/mysql-enterprise-backup/9.7/en/meb-encryptedinnodb.html</u> 
...
Changing the permissions of the error log files might have sn impact on monitoring tools which use an error log file adapter. 
...
Changing the permissions and ownership of the audit log file may have an impact on who can access and edit the audit log. Such changes can affect monitoring tools which may be using a log file adapter or scripted alternatives. Also, the audit log may be used for alerting by infrastructure teams which can affect real-time audit capability. 
...
When configured to use a Keyring plugin or Keyring Component, internal MySQL components and plugins may securely store sensitive information for later retrieval. Associated files for the selected keyring type should have proper permissions. 
...
MySQL is in the process of migrating more plugins to components; 

The following are available 

Components: 

- `component_keyring_file` - a File-Based Keyring Component (Least Secure - for pre-production testing) 

- `component_keyring_encrypted_file` - an Encrypted File-Based Keyring Component 

- `component_keyring_aws` - Amazon Web Services Keyring Component 

- `component_keyring_hashicorp` - Hashicorp Vault Keyring Component 

- `component_keyring_oci` - Vault Keyring Component 

- `component_keyring_kmip` - KMIP Component 

Plugins (all should be migrated to one of the components above): 

- `keyring_file` - File-Based Keyring Plugin (Removed) 

- `keyring_encrypted_file` - Encrypted File-Based Keyring Plugin (Removed) 

- `keyring_okv` - KMIP Plugin (Superseded) 

- `keyring_aws` - Amazon Web Services Keyring Plugin (Deprecated, Superseded) 

- • `keyring_hashicorp` - HashiCorp Vault Keyring Plugin (Deprecated, Superseded) 
...
|`mysql> SELECT * FROM performance_schema.keyring_component_status;`<br>`+---------------------+-------------------------------------------------+`|
|---|
|<br>`| STATUS_KEY          | STATUS_VALUE                                    |`<br>`+---------------------+-------------------------------------------------+`|
|<br>`| Component_name      | component_keyring_file                          |`|
...
##### **Keyring File Component** **_(Least Secure — for pre-production testing)_** 

1. Find the `path` value in the component configuration file (typically `component_keyring_file.cnf` in the plugin directory): 

```
grep -Po '(?<="path":\s*").+(?=")'
/usr/lib/mysql/plugin/component_keyring_file.cnf
```

2. Verify permissions are `750` for `mysql:mysql` for the keyring data file path. 

##### **Keyring Encrypted File Component** 

1. Find the `path` value in the component configuration file (typically `component_keyring_encrypted_file.cnf` in the plugin directory): 

```
grep -Po '(?<="path":\s*").+(?=")'
/usr/lib/mysql/plugin/component_keyring_encrypted_file.cnf
```

2. Verify permissions are `750` for `mysql:mysql` for the keyring data file path. 

3. Verify a secure method for provisioning the passphrase for the encrypted keyring file is in place. 

##### **Keyring KMIP Component** 

1. Locate the component configuration file `component_keyring_kmip.cnf` in the plugin directory and verify that `kmip_configuration_directory` is configured and points to a valid directory. 

2. Verify that the `ssl/` subdirectory within the KMIP configuration directory contains the required TLS certificate files ( `ca.pem` , `client-cert.pem` , `key.pem` ). 

3. Verify permissions are `750` for `mysql:mysql` on the KMIP configuration directory and its contents. 

Page 110 

Internal Only - General 

##### **Keyring OCI Vault Component** 

1. Locate the component configuration file `component_keyring_oci.cnf` in the plugin directory and verify the following keys are configured: 

   - `user` , `tenancy` , `compartment` , `virtual_vault` , `master_key` 

   - `encryption_endpoint` , `management_endpoint` , `vaults_endpoint` , `secrets_endpoint` 

   - `key_file` , `key_fingerprint` 

2. Find the `key_file` value and verify permissions are `750` for `mysql:mysql` on the RSA private key file. 

##### **Keyring HashiCorp Vault Component** 

1. Locate the component configuration file `component_keyring_hashicorp.cnf` in the plugin directory and verify: 

   - `server_url` and `store_path` are configured. 

   - `ca_path` is configured and the CA certificate file permissions are `750` for `mysql:mysql` . 

   - Authentication is configured via either: 

      - AppRole: `role_id` and `secret_id` are present, or 

      - Token: `auth_mode` is set to `token` and `token_path` points to a secured token file. 

2. Verify the token file (if used) permissions are `750` for `mysql:mysql` . 

##### **Keyring AWS Component** 

1. Locate the component configuration file `component_keyring_aws.cnf` in the plugin directory and verify the following keys are configured: 

   - `cmk_id` (the KMS key ARN or ID) 

   - `data_file` (path to the local key storage file) 

   - `aws_authentication` block containing `mode` , `region` , and either `access_key_id` / `access_key_secret` (simple mode) or a process credential provider (native mode). 

2. Find the `data_file` value and verify permissions are `750` for `mysql:mysql` on that file. 

3. Verify the configuration file's permissions are `750` for `mysql:mysql` . 

_Legacy Plugins_ (Superseded — audit only if components are not in use) 

##### **Keyring File Plugin** **_(Superseded)_** 

1. Find the `keyring_file_data` value by executing: 
...
2. Verify permissions are `750` for `mysql:mysql` for the path found above. 

##### **Keyring Encrypted File Plugin** **_(Superseded)_** 

1. Find the `keyring_encrypted_file_data` value by executing: 
...
3. Verify a secure method for provisioning the passphrase is in place. 

##### **Keyring OKV / KMIP Plugin** **_(Superseded)_** 

1. Find the `keyring_okv_conf_dir` value by executing: 

```
grep -Po '(?<=^keyring_okv_conf_dir=).+$' /etc/mysql/my.cnf
```

2. Verify permissions are `750` for `mysql:mysql` for the path found above. 

##### **Keyring OCI Vault Plugin** **_(Superseded)_** 

1. Find the `keyring_oci_key_file` value by executing: 
...
##### **Keyring HashiCorp Vault Plugin** **_(Deprecated)_** 

1. Find the `keyring_hashicorp_store_path` value by executing: 
...
##### **Keyring AWS Plugin** **_(Deprecated)_** 

1. Find the `keyring_aws_conf_file` and `keyring_aws_data_file` values by executing: 

```
grep -Po '(?<=^keyring_aws.*=).+$' /etc/mysql/my.cnf
```

2. Verify permissions are `750` for `mysql:mysql` for both files found above. 

Page 112 

Internal Only - General 

If no a keyring component or a keyring plugin is configured, or if the permissions on any keyring file are not set to 750 for mysql:mysql, this is a fail. 

###### **Remediation:** 

#### **MySQL Keyring Remediation Procedures** 

If no keyring component or plugin is configured, one must be installed and configured. Components are the recommended long-term approach and should be used where possible. Configuration instructions for each component can be found at: 

**Components:** 

- Keyring File — <u>https://dev.mysql.com/doc/refman/9.7/en/keyring-filecomponent.html</u> 

- Keyring Encrypted File — <u>https://dev.mysql.com/doc/refman/9.7/en/keyringencrypted-file-component.html</u> 

- Keyring AWS — <u>https://dev.mysql.com/doc/refman/9.7/en/keyring-awscomponent.html</u> 

- Keyring HashiCorp Vault — <u>https://dev.mysql.com/doc/refman/9.7/en/keyringhashicorp-component.html</u> 

- Keyring OCI Vault — <u>https://dev.mysql.com/doc/refman/9.7/en/keyring-ocicomponent.html</u> 

- Keyring KMIP — <u>https://dev.mysql.com/doc/refman/9.7/en/keyring-kmipcomponent.html</u> 

If a legacy plugin must be used, see the MySQL 9.7 Keyring documentation for plugin configuration, noting that all plugins are superseded or deprecated and should be migrated to their component equivalents. 

To correct file permissions on any keyring file: 

```
chmod 750 <keyring_file>
chown mysql:mysql <keyring_file>
```

###### **References:** 

1. <u>https://dev.mysql.com/doc/refman/9.7/en/keyring-system-variables.html</u> 2. <u>https://blogs.oracle.com/mysql/post/keyring-components</u> 

###### **Additional Information:** 

Use of `component_keyring_file` (or its legacy plugin equivalent `keyring_file` ) is intended for development and testing only. It stores keys in an unencrypted local file and will not satisfy security regulatory requirements which require keys to be managed in a dedicated key vault or hardware security module (HSM). 
...
|---|
|`| sql_mode      | ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,   |`<br>`|               | NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,                  |`<br>`|               | NO_ENGINE_SUBSTITUTION                                    |`<br>`+---------------+-----------------------------------------------------------+`|
...
This recommendation is reliant upon a compliant MySQL keyring component/plugin being configured as described in section 3.10. If no keyring component/plugin is configured, TDE cannot securely manage encryption keys and this control should fail. 
...
The functions `audit_log_filter_set_filter()` and 

`audit_log_filter_set_user()` are used to define rules for auditing. With this feature, you can easily audit successful and/or failed connection events and write to the audit log file. 
...
1. <u>https://dev.mysql.com/doc/refman/9.7/en/audit-log-filtering.html</u> 2. <u>https://dev.mysql.com/doc/refman/9.7/en/audit-log.html</u> 
...
1. <u>https://dev.mysql.com/doc/refman/9.7/en/audit-log-filtering.html</u> 
...
#### _6.7 Set audit_log_strategy to SYNCHRONOUS or SEMISYNCHRONOUS (Automated)_ 
...
1. <u>https://dev.mysql.com/doc/refman/9.7/en/audit-logreference.html#sysvar_audit_log_strategy</u> 
...
1. <u>https://dev.mysql.com/doc/refman/9.7/en/audit-logreference.html#option_mysqld_audit-log</u> 
...
Setting `caching_sha2_password_storage_format=PBKDF2_SHA512` ensures that new password transformations use the preferred format. Setting 

`caching_sha2_password_enforce_storage_format=ON` helps migrate existing accounts by forcing users whose passwords are stored in a different format to change their password after authentication. 
...
#### _7.10 Ensure Dynamic Data Masking is configured for sensitive columns (Manual)_ 
...
Identify tables and columns that contain sensitive data according to the organization’s data classification standard. At minimum, review columns likely to contain values such as SSNs, national identifiers, payment card numbers, tax identifiers, dates of birth, phone numbers, email addresses, account numbers, access tokens, or other regulated data. 

For example, run the queries to identify candidate sensitive columns by common naming patterns: 
...
'information_schema')
  AND REGEXP_LIKE(
        COLUMN_NAME,
'ssn|sin|nin|tax|dob|birth|card|pan|iban|account|phone|email|token|secret|pas
sword',
        'i'
      )
...
For each sensitive column, review the table definition: 

```
SHOW CREATE TABLE <schema_name>.<table_name>\G
```

Confirm that each sensitive column that should be protected has an assigned masking policy. MySQL supports applying a masking policy to a column with syntax such as: 
...
Oracle’s example demonstrates this pattern for applying a masking policy to an SSN column. 

For each assigned masking policy, review the policy definition: 
...
```
SHOW CREATE MASKING POLICY <policy_name>\G
```

The policy should meet all of the following conditions: 

- The policy returns unmasked data only for explicitly approved users or active roles. 

- The default or `ELSE` path returns a masked value. 

- Role-based access is preferred over hard-coded individual user exceptions. 

- The masking function is appropriate for the data type. 

- The policy does not expose more data than required for the use case. 

A finding exists if any sensitive column is directly readable by non-authorized users without a masking policy or if the masking policy allows broad access to unmasked values. 
...
Dynamic data masking is not enabled by default. 

###### **References:** 

1. <u>https://dev.mysql.com/doc/refman/9.7/en/data-masking-components.html</u> 
...
#### _7.11 Ensure Multifactor Authentication is Required for Administrative and Other Designated Accounts (Manual)_ 
...
Review `authentication_policy` and the definitions of designated accounts to determine whether required accounts are configured for MFA. Review administrative privilege assignments for authentication-policy changes and passwordless account creation. 

If designated accounts can authenticate with a single factor where MFA is required, this check fails. 
...
|v7|12.11Require All Remote Login to Use Multi-factor<br>Authentication<br>Require all remote login access to the organization's network to encrypt data<br>in transit and use multi-factor authentication.||●|●|
...
#### _7.12 Ensure WebAuthn is Used for Phishing-Resistant Authentication Where Required (Manual)_ 
...
Where phishing-resistant authentication is required, configure MySQL Enterprise Edition to use WebAuthn for the appropriate factor. For MySQL 9.x, WebAuthn replaces older FIDO-focused wording and supports modern FIDO/FIDO2 authenticators. 

###### **Rationale:** 

WebAuthn provides stronger resistance to phishing and credential replay than password-only authentication. 

###### **Impact:** 

WebAuthn deployment may require compatible devices, browser or client support, and enrollment procedures. 

###### **Audit:** 

Review installed authentication methods and account definitions for designated accounts. Verify WebAuthn is used where phishing-resistant authentication is required and that legacy FIDO-only wording or configurations are not the primary implementation target. 

If designated accounts that require phishing-resistant authentication do not use WebAuthn, this check fails. 

###### **Remediation:** 

Install and configure the MySQL Enterprise WebAuthn authentication support where required. Assign WebAuthn as an approved factor for designated accounts and review any passwordless deployments carefully before approval. 

###### **Default Value:** 

WebAuthn is not enabled by default. 

###### **References:** 

1. <u>https://dev.mysql.com/doc/refman/9.7/en/webauthn-pluggableauthentication.html</u> 
...
|v7|12.11Require All Remote Login to Use Multi-factor<br>Authentication<br>Require all remote login access to the organization's network to encrypt data in<br>transit and use multi-factor authentication.||●|●|
...
|6.7|Set audit_log_strategy to SYNCHRONOUS or<br>SEMISYNCHRONOUS (Automated)|||
...
|7.10|Ensure Dynamic Data Masking is configured for<br>sensitive columns (Manual)|||
|7.11|Ensure Multifactor Authentication is Required for<br>Administrative and Other Designated Accounts (Manual)|||
|7.12|Ensure WebAuthn is Used for Phishing-Resistant<br>Authentication Where Required (Manual)|||
|**8**|**Network**|||
...
|2.1.4|TheBackups ShouldBeProperly Secured|||
...
|3.9|Ensure'audit_log_file' HasAppropriatePermissions|||
|3.10|SecureMySQL Keyring|||
...
|6.8|Ensure theAuditPluginCan't be Unloaded|||
|7.6|Ensure No Users Have Wildcard Hostnames|||
|7.10|Ensure Dynamic Data Masking is configured for sensitive<br>columns|||
...
|6.4|Ensure'log-raw' is Set to'OFF'|||
|6.5|EnsureAuditFilters Capture Connection Attempts|||
|6.6|EnsureALL Events areAudited|||
|6.8|Ensure theAuditPluginCan't be Unloaded|||
...
|7.10|Ensure Dynamic Data Masking is configured for sensitive<br>columns|||
|7.11|Ensure Multifactor Authentication is Required for<br>Administrative and Other DesignatedAccounts|||
|7.12|Ensure WebAuthn is Used for Phishing-Resistant<br>Authentication WhereRequired|||
...
|6.7|Set audit_log_strategy to SYNCHRONOUS or<br>SEMISYNCHRONOUS|||
...
|4.5|Ensure'mysqld' isNot StartedWith '--skip-grant-tables'|||
|4.6|Ensure SymbolicLinks areDisabled|||
|4.7|Ensure the'secure_file_priv' is Configured Correctly|||
|4.8|Ensure'sql_mode'Contains'STRICT_ALL_TABLES'|||
...
|9.2|Ensure 'SOURCE_SSL_VERIFY_SERVER_CERT' is<br>Set to'YES'or '1'|||
|9.3|Ensure'super_priv' isNot Set to'Y' for ReplicationUsers|||
|10.1|Ensure All GroupReplication Traffic is Secured|||
|10.2|Allowlist Approved Servers Belonging to a MySQL<br>InnoDBCluster|||
