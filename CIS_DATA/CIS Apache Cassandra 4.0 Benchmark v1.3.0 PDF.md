...
|**_Recommendation Definitions ..................................................................................... 10_**|
|**Title .......................................................................................................................................... 10**|
|**Assessment Status ................................................................................................................ 10**<br>|
|**Automated ............................................................................................................................................ 10**<br>**Manual .................................................................................................................................................. 10**|
|**Profile ...................................................................................................................................... 10**|
|**Description .............................................................................................................................. 10**|
...
|**Default Value ........................................................................................................................... 11**|
|**References .............................................................................................................................. 11**|
|**CIS Critical Security Controls**<sup>**®**</sup>**(CIS Controls**<sup>**®**</sup>**) ................................................................... 11**|
|**Additional Information ........................................................................................................... 11**|
|**Profile Definitions ................................................................................................................... 12**|
|**Acknowledgements ......................................................................**Error! Bookmark not defined.|
|**_Recommendations ....................................................................................................... 15_**|
|**1 Installation and Updates ..................................................................................................... 15**|
|<br>1.1 Ensure a separate user and group exist for Cassandra (Manual) ...................................... 16|
|1.2 Ensure the latest version of Java is installed (Automated) ................................................. 18|
|1.3 Ensure the latest version of Python is installed (Automated) ............................................. 20<br>1.4 Ensure latest version of Cassandra is installed (Automated) ............................................. 22|
...
|1.5 Ensure the Cassandra service is run as a non-root user (Automated) .............................. 24|
|---|
|1.6 Ensure clocks are synchronized on all nodes (Manual) ..................................................... 26|
|**2 Authentication and Authorization ...................................................................................... 28**<br>|
|2.1 Ensure that authentication is enabled for Cassandra databases (Automated) .................. 29|
|2.2 Ensure that authorization is enabled for Cassandra databases (Automated) .................... 31|
|**3 Access Control / Password Policies .................................................................................. 33**|
|3.1 Ensure the cassandra and superuser roles are separate (Automated) .............................. 34<br>|
|3.2 Ensure that the default password is changed for the cassandra role (Automated) ............ 36|
|3.3 Ensure there are no unnecessary roles or excessive privileges (Manual) ......................... 38<br>3.4 Ensure that Cassandra is run using a non-privileged, dedicated service account<br>(Automated) .............................................................................................................................. 40|
|3.5 Ensure that Cassandra only listens for network connections on authorized interfaces<br>(Manual) ................................................................................................................................... 42|
|3.6 Ensure that Data Center Authorizations is activated (Manual) ........................................... 44|
|3.7 Review User-Defined Roles (Manual) ................................................................................ 46|
|3.8 Review Superuser/Admin Roles (Manual) ......................................................................... 48|
|**4 Auditing and Logging ......................................................................................................... 50**|
|4.1 Ensure that logging is enabled. (Automated) ..................................................................... 51|
|4.2 Ensure that auditing is enabled (Manual) ........................................................................... 53|
|**5 Encryption ............................................................................................................................ 55**<br>|
|5.1 Inter-node Encryption (Automated) .................................................................................... 56|
|5.2 Client Encryption (Automated) ........................................................................................... 58|
|**_Appendix: Summary Table .......................................................................................... 60_**|
|**_Appendix: CIS Controls v7 IG 1 Mapped Recommendations .................................. 62_**|
|**_Appendix: CIS Controls v7 IG 2 Mapped Recommendations .................................. 63_**|
|**_Appendix: CIS Controls v7 IG 3 Mapped Recommendations .................................. 64_**|
|**_Appendix: CIS Controls v7 Unmapped Recommendations ..................................... 65_**|
|**_Appendix: CIS Controls v8 IG 1 Mapped Recommendations .................................. 66_**|
|**_Appendix: CIS Controls v8 IG 2 Mapped Recommendations .................................. 67_**|
|**_Appendix: CIS Controls v8 IG 3 Mapped Recommendations .................................. 68_**|
|**_Appendix: CIS Controls v8 Unmapped Recommendations ..................................... 69_**|
|**_Appendix: Change History ................................................_**_Error! Bookmark not defined._|
...
This document, CIS Apache Cassandra Benchmark, provides prescriptive guidance for establishing a secure configuration posture for Apache Cassandra version 4.0. This guide was tested against Apache Cassandra 4.0.19 running on CentOS Stream 10, but applies to other Linux distributions as well. To obtain the latest version of this guide, please visit <u>http://benchmarks.cisecurity.org. If you have questions, comments, or have</u> identified ways to improve this guide, please write us at <u>feedback@cisecurity.org.</u> 
...
**Editor/s** Randall Mowen Tony Wilwerding 

**Contributor/s** Matthew Reagan Ankur Panthi Chirag Shah Apache Cassandra Community 
...
NOTE: Experimental support for Java 11 was added in Cassandra 4.0 (CASSANDRA9608). Running Cassandra on Java 11 is experimental. Do so at your own risk. 
...
3. <u>http://openjdk.java.net/install/index.html</u> 4. <u>http://cassandra.apache.org/doc/latest/getting_started/installing.html#prerequisite s</u> 
...
- The official apache cassandra website: <u>http://cassandra.apache.org/</u> 

- • DataStax Enterprise: <u>https://www.datastax.com/</u> 
...
1. Stop the Cassandra database. 2. Modify cassandra.yaml file to modify/add entry for authorization: set it to CassandraAuthorizer 
...
- _3.2 Ensure that the default password is changed for the cassandra role (Automated)_ 
...
- _3.6 Ensure that Data Center Authorizations is activated (Manual)_ 
...
1. Stop the Cassandra database on each node. 2. Modify the cassandra.yaml file to modify entry for network_authorizer: set it to CassandraNetworkAuthorizer 
...
#### _3.7 Review User-Defined Roles (Manual)_ 
...
#### _3.8 Review Superuser/Admin Roles (Manual)_ 
...
```
cat cassandra.yaml | grep -A1 "audit_logging_options"
```
...
|||Yes|No|
|**1**|**Installation and Updates**|||
|1.1|Ensure a separate user and group exist for Cassandra<br>(Manual)|o|o|
|1.2|Ensure the latest version of Java is installed (Automated)|o|o|
|1.3|Ensure the latest version of Python is installed<br>(Automated)|o|o|
|1.4|Ensure latest version of Cassandra is installed<br>(Automated)|o|o|
|1.5|Ensure the Cassandra service is run as a non-root user<br>(Automated)|o|o|
|1.6|Ensure clocks are synchronized on all nodes (Manual)|o|o|
|**2**|**Authentication and Authorization**|||
|2.1|Ensure that authentication is enabled for Cassandra<br>databases (Automated)|o|o|
|2.2|Ensure that authorization is enabled for Cassandra<br>databases (Automated)|o|o|
|**3**|**Access Control / Password Policies**|||
|3.1|Ensure the cassandra and superuser roles are separate<br>(Automated)|o|o|
|3.2|Ensure that the default password is changed for the<br>cassandra role (Automated)|o|o|
|3.3|Ensure there are no unnecessary roles or excessive<br>privileges (Manual)|o|o|
|3.4|Ensure that Cassandra is run using a non-privileged,<br>dedicated service account (Automated)|o|o|
...
|---|---|---|---|
|||Yes|No|
|3.5|Ensure that Cassandra only listens for network<br>connections on authorized interfaces (Manual)|o|o|
|3.6|Ensure that Data Center Authorizations is activated<br>(Manual)|o|o|
|3.7|Review User-Defined Roles (Manual)|o|o|
|3.8|Review Superuser/Admin Roles (Manual)|o|o|
|**4**|**Auditing and Logging**|||
|4.1|Ensure that logging is enabled. (Automated)|o|o|
|4.2|Ensure that auditing is enabled (Manual)|o|o|
|**5**|**Encryption**|||
|5.1|Inter-node Encryption (Automated)|o|o|
|5.2|Client Encryption (Automated)|o|o|
...
|---|---|---|---|
|||**Yes**|**No**|
|1.1|Ensure a separate userand group exist forCassandra|o|o|
|1.5|Ensure the Cassandra service is run as a non-root user|o|o|
|3.1|Ensurethe cassandra and superuser roles are separate|o|o|
|3.3|Ensure there are no unnecessary roles or excessive<br>privileges|o|o|
|3.4|Ensure that Cassandra is run using a non-privileged,<br>dedicated service account|o|o|
|3.7|ReviewUser-DefinedRoles|o|o|
|3.8|ReviewSuperuser/Admin Roles|o|o|
|4.2|Ensure that auditingis enabled|o|o|
...
|||**Yes**|**No**|
|1.1|Ensure a separate userand group exist forCassandra|o|o|
|1.2|Ensure the latest version of Java is installed|o|o|
|1.3|Ensurethelatest versionof Python isinstalled|o|o|
|1.4|Ensurelatest versionofCassandraisinstalled|o|o|
|1.5|Ensure the Cassandra service is run as a non-root user|o|o|
|1.6|Ensure clocks are synchronized onall nodes|o|o|
|3.1|Ensurethe cassandra and superuser roles are separate|o|o|
|3.2|Ensure that the default password is changed for the<br>cassandra role|o|o|
|3.3|Ensure there are no unnecessary roles or excessive<br>privileges|o|o|
|3.4|Ensure that Cassandra is run using a non-privileged,<br>dedicated service account|o|o|
|3.5|Ensure that Cassandra only listens for network<br>connections onauthorizedinterfaces|o|o|
|3.7|ReviewUser-DefinedRoles|o|o|
|3.8|ReviewSuperuser/Admin Roles|o|o|
|4.1|Ensure that loggingis enabled.|o|o|
|4.2|Ensurethatauditingis enabled|o|o|
|5.1|Inter-nodeEncryption|o|o|
|5.2|Client Encryption|o|o|
...
|1.5|Ensure the Cassandra service is run as a non-root user|o|o|
|1.6|Ensure clocks are synchronized onall nodes|o|o|
|2.1|Ensure that authentication is enabled for Cassandra<br>databases|o|o|
|2.2|Ensure that authorization is enabled for Cassandra<br>databases|o|o|
|3.1|Ensurethe cassandra and superuser roles are separate|o|o|
|3.2|Ensure that the default password is changed for the<br>cassandrarole|o|o|
|3.3|Ensure there are no unnecessary roles or excessive<br>privileges|o|o|
|3.4|Ensure that Cassandra is run using a non-privileged,<br>dedicated service account|o|o|
|3.5|Ensure that Cassandra only listens for network<br>connections on authorized interfaces|o|o|
|3.6|Ensure that Data Center Authorizations is activated|o|o|
|3.7|ReviewUser-DefinedRoles|o|o|
|3.8|ReviewSuperuser/Admin Roles|o|o|
|4.1|Ensurethat loggingis enabled.|o|o|
|4.2|Ensurethatauditingis enabled|o|o|
|5.1|Inter-nodeEncryption|o|o|
|5.2|Client Encryption|o|o|
...
|3.4|Ensure that Cassandra is run using a non-privileged,<br>dedicated service account|o|o|
|3.5|Ensure that Cassandra only listens for network<br>connections on authorized interfaces|o|o|
|3.6|Ensurethat Data Center Authorizationsis activated|o|o|
|3.8|ReviewSuperuser/Admin Roles|o|o|
|4.1|Ensurethat loggingis enabled.|o|o|
|4.2|Ensurethatauditingis enabled|o|o|
|5.1|Inter-nodeEncryption|o|o|
...
|---|---|---|
|1-22-2026|1.3.0|Applied and tested audits<br>against v4.0.15|
|1-10-2026|1.3.0|Applied and tested<br>remediations against<br>v4.0.15|
|1-09-2026|1.3.0|Installed and tested Apache<br>Cassandra v4.0.15 on<br>CentOs Stream 10|
|1/15/2025|1.2.0|Validated audit and<br>remediations against<br>Cassandra Version 4.0.15|
|1/10/2025|1.2.0|Ticket #19829<br>Updated audit command for<br>ensure auditing is enabled.|
|1/10/2025|1.2.0|Ticket #19830<br>Added audit command to<br>validate Client Encryption|
|1/10/2025|1.2.0|Ticket #19828<br>Modified audit section and<br>output of audit command for<br>recommendation 3.5<br>“Ensure the Data Center<br>Authorization is Active”|
|1/10/2025|1.2.0|Ticket # 19827<br>Added automated audit<br>steps to audit network<br>connection listener and<br>authorized interface ports.|
