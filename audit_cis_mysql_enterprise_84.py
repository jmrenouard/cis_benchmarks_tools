...
<head>
    ...
    <title>CIS Benchmark Audit Report MySQL Enterprise 8.4 Benchmark</title>
...
def generate_html_report(results, overall_score, categories_scores, filename=None, lang="en", execution_context=None):
    if not filename:
        filename = "reports/rapport_cis_mysql_enterprise_84.html"
    ...
    html_output = load_html_template().format_map(SafeDict(
        product_title="MySQL Enterprise 8.4",
        benchmark_title="MySQL Enterprise 8.4",
...
if __name__ == "__main__":
    ...
    rules_data = load_recommendations("mysql_enterprise_84")
    ...
    export_results(check_results, overall_score, categories_scores, target_name="mysql_enterprise_84", filename=args.output, fmt=args.format, lang=args.lang)