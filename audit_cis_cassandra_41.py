...
<head>
    ...
    <title>CIS Benchmark Audit Report Apache Cassandra 4.1.0 Benchmark</title>
...
<body class="font-sans bg-gray-100 text-gray-800 p-6">
    <div class="container mx-auto bg-white p-8 rounded-lg shadow-lg">
        <h1 class="text-3xl font-bold mb-6 text-gray-900">CIS Benchmark Audit Report Apache Cassandra 4.1.0 Benchmark</h1>
...
def generate_html_report(results, overall_score, categories_scores, filename=None, lang="en", execution_context=None):
    if not filename:
        filename = "reports/rapport_cis_cassandra_41.html"
    ...
    html_output = load_html_template().format_map(SafeDict(
        product_title="Cassandra 4.1",
        benchmark_title="Cassandra 4.1",
...
if __name__ == "__main__":
    ...
    rules_data = load_recommendations("cassandra_41")
    ...
    export_results(check_results, overall_score, categories_scores, target_name="cassandra_41", filename=args.output, fmt=args.format, lang=args.lang)