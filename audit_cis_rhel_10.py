...
def generate_html_report(results, overall_score, categories_scores, filename=None, lang="en"):
    ...
    for item in results:
        ...
        <tr style="border-bottom: 1px solid #e5e7eb;">
            <td style="padding: 12px; font-weight: bold;">{html.escape(str(item['id']))}</td>
            ...
            <td style="padding: 12px; font-family: monospace; font-size: 12px;">{html.escape(str(item.get('stdout', '')[:100]))}</td>
...
<head>
    <meta charset="UTF-8">
    <title>CIS Benchmark Audit Report Red Hat Enterprise Linux 10 (STIG)</title>
    <style>
...
<body>
    <div class="container">
        <div class="header">
            <h1>🛡️ CIS Benchmark Audit Report Red Hat Enterprise Linux 10 (STIG)</h1>
...
if __name__ == "__main__":
    ...
    rules_data = load_recommendations("rhel_10")
