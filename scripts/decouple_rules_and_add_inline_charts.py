#!/usr/bin/env python3
"""
1. Externalize and decouple RECOMMENDATIONS_DATA into `rules/<target_key>.json` for all 18 targets.
2. Inject 100% self-contained Pure Inline SVG & HTML5 Donut and Category Bar Charts into export_results / HTML reports.
...
print(f"Decoupling rules to `rules/` and injecting inline SVG charts across {len(audit_files)} audit scripts...")
...
print("✅ Externalized rules and updated inline chart engines across all audit scripts!")
