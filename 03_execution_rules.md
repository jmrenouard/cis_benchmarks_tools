...
## 🧠 Rationale
To ensure consistency, reliability, and security across all database auditing scripts. Strict adherence to these rules prevents broken tests, inconsistent naming, and environment dependencies.
