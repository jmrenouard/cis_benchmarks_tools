...
if __name__ == "__main__":
    print("🚀 Starting CIS audit PostgreSQL 18 Benchmark ...")
    ...
    generate_html_report(check_results, overall_score, categories_scores, total_manual, total_errors, total_na, passed_auto_count, failed_auto_count, error_auto_count, na_auto_count, category_labels, category_pass_counts, category_fail_counts, category_error_counts, category_na_counts, "reports/rapport_cis_postgresql_18.html")
    ...
    print("Consulte le fichier reports/rapport_cis_postgresql_18.html pour les détails.")
