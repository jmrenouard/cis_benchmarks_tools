...
def run_command(command):
    ...
    try:
        ...
        return "", f"Error: La commande a dépassé le délai d'exécution ({30}s).", 124
    except FileNotFoundError:
        cmd_name = command.split()[0] if command else "N/A"
        return "", f"Error: Command '{cmd_name}' introuvable.", 127
...
if __name__ == "__main__":
    print("🚀 Starting CIS audit MariaDB 10.11 Benchmark v1.0.0 ...")
    print(f"ℹ️ Using command MySQL/MariaDB: '{MYSQL_CMD}' (Ensure database connection is configured)")
