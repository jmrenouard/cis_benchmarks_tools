...
<head>
    ...
    <title>Rapport CIS PostgreSQL 16 Benchmark</title>
...
<body class="font-sans bg-gray-100 text-gray-800 p-6">
    <div class="container mx-auto bg-white p-8 rounded-lg shadow-lg">
        <h1 class="text-3xl font-bold mb-6 text-gray-900">Rapport CIS PostgreSQL 16 Benchmark</h1>
...
if __name__ == "__main__":
    print("🚀 Démarrage de l'audit CIS PostgreSQL 16 Benchmark ...")
