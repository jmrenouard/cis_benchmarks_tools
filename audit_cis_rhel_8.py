...
<head>
    <meta charset="UTF-8">
    <title>CIS Benchmark Audit Report Red Hat Enterprise Linux 8 v1.4.0</title>
    <style>
...
<body>
    <div class="container">
        <div class="header">
            <h1>🛡️ CIS Benchmark Audit Report Red Hat Enterprise Linux 8 (STIG)</h1>
    ...
    print(f"📄 RHEL 8 HTML report successfully generated: {filename}")
...
if __name__ == "__main__":
    ...
    rules_data = load_recommendations("rhel_8")
    ...
    export_results(check_results, overall_score, categories_scores, target_name="rhel_8", filename=args.output, fmt=args.format, lang=args.lang)