# ⚠️ Potential Issues & Technical Debt Backlog (v1.2.5)

Ce document recense les problèmes potentiels, risques de bugs, remarques de sécurité et retours des revues de code (Pull Requests #17 à #75) identifiés sur le projet **CIS Benchmarks Tools**.
...
## 1. Résolus dans les versions v1.2.0 - v1.2.5 ✅
