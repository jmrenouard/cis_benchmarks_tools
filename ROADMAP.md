...
> 4. **English Language Requirement**: All documentation, code docstrings, comments, CLI outputs, and reports MUST be in **English**.
...
### Phase 3: Linux System Extensions & Subprocess Security (Completed ✅ - v1.5.0)
...
#### 2. Subprocess Security Migration (`shell=False` / Parameter Lists)
...
#### 3. Full Project Translation to English
- [x] Translation of all documentation files (`README.md`, `ROADMAP.md`, `POTENTIAL_ISSUES.md`, `.agents/AGENTS.md`).
- [x] Translation of code docstrings, comments, CLI outputs, and HTML audit report templates.

---

### Phase 4: CI/CD Pipeline & Advanced Features (Long Term Backlog 🚀)
