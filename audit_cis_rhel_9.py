...
<head>
    <meta charset="UTF-8">
    <title>Rapport d'Audit CIS Red Hat Enterprise Linux 9 v1.4.0</title>
    <style>
...
<body>
    <div class="container">
        <div class="header">
            <h1>🛡️ Rapport d'Audit CIS Red Hat Enterprise Linux 9 (STIG)</h1>
    ...
    print(f"📄 Rapport HTML RHEL 9 généré avec succès : {filename}")
