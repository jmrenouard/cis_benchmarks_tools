...
def generate_html_report(results, overall_score, categories_scores, filename="reports/rapport_cis_rhel_9.html", lang="en"):
...
<body>
    ...
    print(f"📄 HTML Report RHEL 9 successfully generated : {filename}")
