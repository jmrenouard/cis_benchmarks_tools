...
<head>
    ...
    <title>Rapport CIS MariaDB 10.6 Benchmark</title>
...
if __name__ == "__main__":
    print("🚀 Démarrage de l'audit CIS MariaDB 10.6 Benchmark v1.1.0 ...")
    ...
    try:
        ...
        print("Consulte le fichier rapport_cis_mariadb_106.html pour les détails.")
