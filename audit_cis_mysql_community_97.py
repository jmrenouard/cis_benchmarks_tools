...
<head>
    ...
    <title>Rapport CIS MySQL Community 9.7 Benchmark</title>
...
def run_command(command):
    ...
    try:
        # Utilise un tableau d arguments ["/bin/bash", "-c", command] pour permettre les pipelines et les redirections comme dans les exemples
...
if __name__ == "__main__":
    print("🚀 Démarrage de l'audit CIS MySQL Community 9.7 Benchmark ...")
