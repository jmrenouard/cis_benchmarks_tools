...
<head>
    ...
    <title>Rapport CIS Apache Cassandra 5.0.0 Benchmark</title>
...
<body class="font-sans bg-gray-100 text-gray-800 p-6">
    <div class="container mx-auto bg-white p-8 rounded-lg shadow-lg">
        <h1 class="text-3xl font-bold mb-6 text-gray-900">Rapport CIS Apache Cassandra 5.0.0 Benchmark</h1>
...
if __name__ == "__main__":
    print("🚀 Démarrage de l'audit CIS Apache Cassandra 5.0.0 Benchmark ...")
    ...
    try:
        ...
        print("Consultez le fichier rapport_cis_cassandra_50.html pour les détails.")
