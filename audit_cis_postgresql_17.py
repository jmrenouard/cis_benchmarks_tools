...
def run_command(command):
    ...
    try:
        ...
        return "", f"Error: Command '{command.split()[0]}' introuvable.", 127 # Code 127 pour command not found
...
if __name__ == "__main__":
    print("🚀 Starting CIS audit PostgreSQL 17 Benchmark ...")
    ...
    generate_html_report(check_results, overall_score, categories_scores, total_manual, total_errors, total_na, passed_auto_count, failed_auto_count, error_auto_count, na_auto_count, category_labels, category_pass_counts, category_fail_counts, category_error_counts, category_na_counts, "reports/rapport_cis_postgresql_17.html")
    ...
    print("Consulte le fichier reports/rapport_cis_postgresql_17.html pour les détails.")
