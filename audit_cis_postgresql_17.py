...
<head>
    ...
    <title>CIS Benchmark Audit Report PostgreSQL 17 Benchmark</title>
...
<body class="font-sans bg-gray-100 text-gray-800 p-6">
    <div class="container mx-auto bg-white p-8 rounded-lg shadow-lg">
        <h1 class="text-3xl font-bold mb-6 text-gray-900">CIS Benchmark Audit Report PostgreSQL 17 Benchmark</h1>
...
def generate_html_report(results, overall_score, categories_scores, filename=None, lang="en", execution_context=None):
    if not filename:
        filename = "reports/rapport_cis_postgresql_17.html"
    ...
    html_output = load_html_template().format_map(SafeDict(
        product_title="PostgreSQL 17",
        benchmark_title="PostgreSQL 17",
